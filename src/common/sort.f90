...
contains
      ...
      pure subroutine sort_increasing(x, y, n)
            !
            ! Sort array of real number x in increasing order and carry y along.
            !
      ...
      pure subroutine sort_decreasing(x, y, n)
            !
            ! Sort array of real numbers x in decreasing order and carry y along.
            !
            real(F64), dimension(:), intent(inout) :: x
            integer, dimension(:), intent(inout)   :: y
            integer, intent(in)                    :: n
