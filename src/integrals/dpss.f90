...
contains
      ...
      subroutine ints2e_dpss_perm(shell1, a, shell2, b, shell3, c, shell4, d, gabcd, permutation)
            ...
            case (ERI_PDSS)
                call ints2e_dpss(shell2, b, shell1, a, shell3, c, shell4, d, gabcd, 1, 6, 1, 1)
            case (ERI_SSDP)
                call ints2e_dpss(shell3, c, shell4, d, shell1, a, shell2, b, gabcd, 3, 1, 18, 18)
            case (ERI_SSPD)
                call ints2e_dpss(shell4, d, shell3, c, shell1, a, shell2, b, gabcd, 1, 6, 18, 18)
            case default
                call ints2e_dpss(shell1, a, shell2, b, shell3, c, shell4, d, gabcd, 3, 1, 1, 1)
            end select
       end subroutine ints2e_dpss_perm
    

    subroutine ints2e_dpss(shell1, a, shell2, b, shell3, c, shell4, d, gabcd, ka, kb, kc, kd)
            integer, intent(in) :: a, b, c, d
            integer, intent(in) :: shell1, shell2, shell3, shell4
            double precision, dimension(:), intent(out) :: gabcd
