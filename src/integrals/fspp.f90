! File generated automatically. 2012-05-22 23:38:17 UTC
...
contains
      ...
      subroutine ints2e_fspp_perm(shell1, a, shell2, b, shell3, c, shell4, d, gabcd, permutation)
            ...
            case (ERI_SFPP)
                call ints2e_fspp(shell2, b, shell1, a, shell3, c, shell4, d, gabcd, 9, 90, 3, 1)
            case (ERI_PPFS)
                call ints2e_fspp(shell3, c, shell4, d, shell1, a, shell2, b, gabcd, 1, 1, 30, 10)
            case (ERI_PPSF)
                call ints2e_fspp(shell4, d, shell3, c, shell1, a, shell2, b, gabcd, 1, 10, 30, 10)
            case default
                call ints2e_fspp(shell1, a, shell2, b, shell3, c, shell4, d, gabcd, 9, 9, 3, 1)
            end select
       end subroutine ints2e_fspp_perm
    

    subroutine ints2e_fspp(shell1, a, shell2, b, shell3, c, shell4, d, gabcd, ka, kb, kc, kd)
            integer, intent(in) :: a, b, c, d
            integer, intent(in) :: shell1, shell2, shell3, shell4
            double precision, dimension(:), intent(out) :: gabcd
...
cdsum = cdsum + etuv2(6) * gabtuv(0, 1, 0)
cdsum = cdsum + etuv2(7) * gabtuv(1, 1, 0)
idx = 6 * ka + 0 * kb + 0 * kc + 1 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(2, l, shell4) * cdsum
cdsum = etuv2(8) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(9) * gabtuv(1, 0, 0)
cdsum = cdsum + etuv2(10) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(11) * gabtuv(1, 0, 1)
idx = 6 * ka + 0 * kb + 0 * kc + 2 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(3, l, shell4) * cdsum
norm123 = norm12 * nrml(2, k, shell3)
cdsum = etuv2(12) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(13) * gabtuv(1, 0, 0)
...
cdsum = cdsum + etuv2(17) * gabtuv(0, 1, 0)
cdsum = cdsum + etuv2(18) * gabtuv(0, 2, 0)
idx = 6 * ka + 0 * kb + 1 * kc + 1 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(2, l, shell4) * cdsum
cdsum = etuv2(19) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(20) * gabtuv(0, 1, 0)
cdsum = cdsum + etuv2(21) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(22) * gabtuv(0, 1, 1)
idx = 6 * ka + 0 * kb + 1 * kc + 2 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(3, l, shell4) * cdsum
norm123 = norm12 * nrml(3, k, shell3)
cdsum = etuv2(23) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(24) * gabtuv(1, 0, 0)
...
cdsum = cdsum + etuv2(29) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(30) * gabtuv(0, 1, 1)
idx = 6 * ka + 0 * kb + 2 * kc + 1 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(2, l, shell4) * cdsum
cdsum = etuv2(31) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(32) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(33) * gabtuv(0, 0, 2)
idx = 6 * ka + 0 * kb + 2 * kc + 2 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(3, l, shell4) * cdsum
...
cdsum = cdsum + etuv2(6) * gabtuv(0, 1, 0)
cdsum = cdsum + etuv2(7) * gabtuv(1, 1, 0)
idx = 7 * ka + 0 * kb + 0 * kc + 1 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(2, l, shell4) * cdsum
cdsum = etuv2(8) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(9) * gabtuv(1, 0, 0)
cdsum = cdsum + etuv2(10) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(11) * gabtuv(1, 0, 1)
idx = 7 * ka + 0 * kb + 0 * kc + 2 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(3, l, shell4) * cdsum
norm123 = norm12 * nrml(2, k, shell3)
cdsum = etuv2(12) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(13) * gabtuv(1, 0, 0)
...
cdsum = cdsum + etuv2(17) * gabtuv(0, 1, 0)
cdsum = cdsum + etuv2(18) * gabtuv(0, 2, 0)
idx = 7 * ka + 0 * kb + 1 * kc + 1 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(2, l, shell4) * cdsum
cdsum = etuv2(19) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(20) * gabtuv(0, 1, 0)
cdsum = cdsum + etuv2(21) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(22) * gabtuv(0, 1, 1)
idx = 7 * ka + 0 * kb + 1 * kc + 2 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(3, l, shell4) * cdsum
norm123 = norm12 * nrml(3, k, shell3)
cdsum = etuv2(23) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(24) * gabtuv(1, 0, 0)
...
cdsum = cdsum + etuv2(29) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(30) * gabtuv(0, 1, 1)
idx = 7 * ka + 0 * kb + 2 * kc + 1 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(2, l, shell4) * cdsum
cdsum = etuv2(31) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(32) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(33) * gabtuv(0, 0, 2)
idx = 7 * ka + 0 * kb + 2 * kc + 2 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(3, l, shell4) * cdsum
...
cdsum = cdsum + etuv2(6) * gabtuv(0, 1, 0)
cdsum = cdsum + etuv2(7) * gabtuv(1, 1, 0)
idx = 8 * ka + 0 * kb + 0 * kc + 1 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(2, l, shell4) * cdsum
cdsum = etuv2(8) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(9) * gabtuv(1, 0, 0)
cdsum = cdsum + etuv2(10) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(11) * gabtuv(1, 0, 1)
idx = 8 * ka + 0 * kb + 0 * kc + 2 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(3, l, shell4) * cdsum
norm123 = norm12 * nrml(2, k, shell3)
cdsum = etuv2(12) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(13) * gabtuv(1, 0, 0)
...
cdsum = cdsum + etuv2(17) * gabtuv(0, 1, 0)
cdsum = cdsum + etuv2(18) * gabtuv(0, 2, 0)
idx = 8 * ka + 0 * kb + 1 * kc + 1 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(2, l, shell4) * cdsum
cdsum = etuv2(19) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(20) * gabtuv(0, 1, 0)
cdsum = cdsum + etuv2(21) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(22) * gabtuv(0, 1, 1)
idx = 8 * ka + 0 * kb + 1 * kc + 2 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(3, l, shell4) * cdsum
norm123 = norm12 * nrml(3, k, shell3)
cdsum = etuv2(23) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(24) * gabtuv(1, 0, 0)
...
cdsum = cdsum + etuv2(29) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(30) * gabtuv(0, 1, 1)
idx = 8 * ka + 0 * kb + 2 * kc + 1 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(2, l, shell4) * cdsum
cdsum = etuv2(31) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(32) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(33) * gabtuv(0, 0, 2)
idx = 8 * ka + 0 * kb + 2 * kc + 2 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(3, l, shell4) * cdsum
...
cdsum = cdsum + etuv2(6) * gabtuv(0, 1, 0)
cdsum = cdsum + etuv2(7) * gabtuv(1, 1, 0)
idx = 9 * ka + 0 * kb + 0 * kc + 1 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(2, l, shell4) * cdsum
cdsum = etuv2(8) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(9) * gabtuv(1, 0, 0)
cdsum = cdsum + etuv2(10) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(11) * gabtuv(1, 0, 1)
idx = 9 * ka + 0 * kb + 0 * kc + 2 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(3, l, shell4) * cdsum
norm123 = norm12 * nrml(2, k, shell3)
cdsum = etuv2(12) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(13) * gabtuv(1, 0, 0)
...
cdsum = cdsum + etuv2(17) * gabtuv(0, 1, 0)
cdsum = cdsum + etuv2(18) * gabtuv(0, 2, 0)
idx = 9 * ka + 0 * kb + 1 * kc + 1 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(2, l, shell4) * cdsum
cdsum = etuv2(19) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(20) * gabtuv(0, 1, 0)
cdsum = cdsum + etuv2(21) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(22) * gabtuv(0, 1, 1)
idx = 9 * ka + 0 * kb + 1 * kc + 2 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(3, l, shell4) * cdsum
norm123 = norm12 * nrml(3, k, shell3)
cdsum = etuv2(23) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(24) * gabtuv(1, 0, 0)
...
cdsum = cdsum + etuv2(29) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(30) * gabtuv(0, 1, 1)
idx = 9 * ka + 0 * kb + 2 * kc + 1 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(2, l, shell4) * cdsum
cdsum = etuv2(31) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(32) * gabtuv(0, 0, 1)
cdsum = cdsum + etuv2(33) * gabtuv(0, 0, 2)
idx = 9 * ka + 0 * kb + 2 * kc + 2 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(3, l, shell4) * cdsum
!
