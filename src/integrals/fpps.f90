...
contains
      ...
      subroutine ints2e_fpps_perm(shell1, a, shell2, b, shell3, c, shell4, d, &
           gabcd, m1, m2, m3, m4)
            ...
            if (brasum .eq. 4) then               
                ...
                if (m1 .eq. 3) then
                    call ints2e_fpps(shell1, a, shell2, b, &
                        s2(1), a2(1), s2(0), a2(0), gabcd, 9, 3, 1, 1)
                else
                    call ints2e_fpps(shell2, b, shell1, a, &
                        s2(1), a2(1), s2(0), a2(0), gabcd, 3, 30, 1, 1)
                end if
            else     
                a2(m1) = a
                s2(m1) = shell1
                ...
                if (m3 .eq. 3) then
                    call ints2e_fpps(shell3, c, shell4, d, &
                        s2(1), a2(1), s2(0), a2(0), gabcd, 3, 1, 30, 30)
                else
                    call ints2e_fpps(shell4, d, shell3, c, &
                        s2(1), a2(1), s2(0), a2(0), gabcd, 1, 10, 30, 30)
                end if
            end if
      end subroutine ints2e_fpps_perm
    

    subroutine ints2e_fpps(shell1, a, shell2, b, shell3, c, shell4, d, gabcd, ka, kb, kc, kd)
            integer, intent(in) :: a, b, c, d
            integer, intent(in) :: shell1, shell2, shell3, shell4
            double precision, dimension(:), intent(out) :: gabcd
...
cdsum = etuv2(3) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(4) * gabtuv(0, 1, 0)
idx = 6 * ka + 1 * kb + 1 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
norm123 = norm12 * nrml(3, k, shell3)
cdsum = etuv2(5) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(6) * gabtuv(0, 0, 1)
idx = 6 * ka + 1 * kb + 2 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
...
cdsum = etuv2(3) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(4) * gabtuv(0, 1, 0)
idx = 6 * ka + 2 * kb + 1 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
norm123 = norm12 * nrml(3, k, shell3)
cdsum = etuv2(5) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(6) * gabtuv(0, 0, 1)
idx = 6 * ka + 2 * kb + 2 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
...
cdsum = etuv2(3) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(4) * gabtuv(0, 1, 0)
idx = 7 * ka + 1 * kb + 1 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
norm123 = norm12 * nrml(3, k, shell3)
cdsum = etuv2(5) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(6) * gabtuv(0, 0, 1)
idx = 7 * ka + 1 * kb + 2 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
...
cdsum = etuv2(3) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(4) * gabtuv(0, 1, 0)
idx = 7 * ka + 2 * kb + 1 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
norm123 = norm12 * nrml(3, k, shell3)
cdsum = etuv2(5) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(6) * gabtuv(0, 0, 1)
idx = 7 * ka + 2 * kb + 2 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
...
cdsum = etuv2(3) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(4) * gabtuv(0, 1, 0)
idx = 8 * ka + 1 * kb + 1 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
norm123 = norm12 * nrml(3, k, shell3)
cdsum = etuv2(5) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(6) * gabtuv(0, 0, 1)
idx = 8 * ka + 1 * kb + 2 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
...
cdsum = etuv2(3) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(4) * gabtuv(0, 1, 0)
idx = 8 * ka + 2 * kb + 1 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
norm123 = norm12 * nrml(3, k, shell3)
cdsum = etuv2(5) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(6) * gabtuv(0, 0, 1)
idx = 8 * ka + 2 * kb + 2 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
...
cdsum = etuv2(3) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(4) * gabtuv(0, 1, 0)
idx = 9 * ka + 1 * kb + 1 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
norm123 = norm12 * nrml(3, k, shell3)
cdsum = etuv2(5) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(6) * gabtuv(0, 0, 1)
idx = 9 * ka + 1 * kb + 2 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
...
cdsum = etuv2(3) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(4) * gabtuv(0, 1, 0)
idx = 9 * ka + 2 * kb + 1 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
norm123 = norm12 * nrml(3, k, shell3)
cdsum = etuv2(5) * gabtuv(0, 0, 0)
cdsum = cdsum + etuv2(6) * gabtuv(0, 0, 1)
idx = 9 * ka + 2 * kb + 2 * kc + 0 * kd + 1
gabcd(idx) = gabcd(idx) + norm123 * nrml(1, l, shell4) * cdsum
!
