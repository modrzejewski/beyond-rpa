...
real(F64), dimension(:), intent(in) :: Ez
real(F64), dimension(:), intent(in) :: R
S(1:6) = Ez(1)*Ey(2)*(Ex(2)*R(1:6) - Ex(3)*R(2:7)) + Ey(3)*Ez(1)*(-Ex(2)*R(9:14)  &
   + Ex(3)*R(10:15))
S(7:11) = Ez(1)*Ey(2)*(Ex(2)*R(9:13) - Ex(3)*R(10:14)) + Ey(3)*Ez(1)*(-Ex(2)*R(16:20)  &
   + Ex(3)*R(17:21))
S(12:15) = Ez(1)*Ey(2)*(Ex(2)*R(16:19) - Ex(3)*R(17:20)) + Ey(3)*Ez(1)*(-Ex(2)*R(22:25)  &
   + Ex(3)*R(23:26))
S(16:18) = Ez(1)*Ey(2)*(Ex(2)*R(22:24) - Ex(3)*R(23:25)) + Ey(3)*Ez(1)*(-Ex(2)*R(27:29)  &
   + Ex(3)*R(28:30))
S(19:20) = Ez(1)*Ey(2)*(Ex(2)*R(27:28) - Ex(3)*R(28:29)) + Ey(3)*Ez(1)*(-Ex(2)*R(31:32)  &
   + Ex(3)*R(32:33))
S(21) = Ez(1)*Ey(2)*(Ex(2)*R(31) - Ex(3)*R(32)) + Ey(3)*Ez(1)*(-Ex(2)*R(34) + Ex(3) &
   *R(35))
S(22:26) = Ez(1)*Ey(2)*(Ex(2)*R(37:41) - Ex(3)*R(38:42)) + Ey(3)*Ez(1)*(-Ex(2)*R(44:48)  &
   + Ex(3)*R(45:49))
S(27:30) = Ez(1)*Ey(2)*(Ex(2)*R(44:47) - Ex(3)*R(45:48)) + Ey(3)*Ez(1)*(-Ex(2)*R(50:53)  &
   + Ex(3)*R(51:54))
S(31:33) = Ez(1)*Ey(2)*(Ex(2)*R(50:52) - Ex(3)*R(51:53)) + Ey(3)*Ez(1)*(-Ex(2)*R(55:57)  &
   + Ex(3)*R(56:58))
S(34:35) = Ez(1)*Ey(2)*(Ex(2)*R(55:56) - Ex(3)*R(56:57)) + Ey(3)*Ez(1)*(-Ex(2)*R(59:60)  &
   + Ex(3)*R(60:61))
S(36) = Ez(1)*Ey(2)*(Ex(2)*R(59) - Ex(3)*R(60)) + Ey(3)*Ez(1)*(-Ex(2)*R(62) + Ex(3) &
   *R(63))
S(37:40) = Ez(1)*Ey(2)*(Ex(2)*R(65:68) - Ex(3)*R(66:69)) + Ey(3)*Ez(1)*(-Ex(2)*R(71:74)  &
   + Ex(3)*R(72:75))
S(41:43) = Ez(1)*Ey(2)*(Ex(2)*R(71:73) - Ex(3)*R(72:74)) + Ey(3)*Ez(1)*(-Ex(2)*R(76:78)  &
   + Ex(3)*R(77:79))
S(44:45) = Ez(1)*Ey(2)*(Ex(2)*R(76:77) - Ex(3)*R(77:78)) + Ey(3)*Ez(1)*(-Ex(2)*R(80:81)  &
   + Ex(3)*R(81:82))
S(46) = Ez(1)*Ey(2)*(Ex(2)*R(80) - Ex(3)*R(81)) + Ey(3)*Ez(1)*(-Ex(2)*R(83) + Ex(3) &
   *R(84))
S(47:49) = Ez(1)*Ey(2)*(Ex(2)*R(86:88) - Ex(3)*R(87:89)) + Ey(3)*Ez(1)*(-Ex(2)*R(91:93)  &
   + Ex(3)*R(92:94))
S(50:51) = Ez(1)*Ey(2)*(Ex(2)*R(91:92) - Ex(3)*R(92:93)) + Ey(3)*Ez(1)*(-Ex(2)*R(95:96)  &
   + Ex(3)*R(96:97))
S(52) = Ez(1)*Ey(2)*(Ex(2)*R(95) - Ex(3)*R(96)) + Ey(3)*Ez(1)*(-Ex(2)*R(98) + Ex(3) &
   *R(99))
S(53:54) = Ez(1)*Ey(2)*(Ex(2)*R(101:102) - Ex(3)*R(102:103)) + Ey(3)*Ez(1)*(-Ex(2) &
   *R(105:106) + Ex(3)*R(106:107))
S(55) = Ez(1)*Ey(2)*(Ex(2)*R(105) - Ex(3)*R(106)) + Ey(3)*Ez(1)*(-Ex(2)*R(108) + Ex(3) &
   *R(109))
S(56) = Ez(1)*Ey(2)*(Ex(2)*R(111) - Ex(3)*R(112)) + Ey(3)*Ez(1)*(-Ex(2)*R(114) + Ex(3) &
   *R(115))
