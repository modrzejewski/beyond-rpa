...
real(F64), dimension(:), intent(in) :: Ez
real(F64), dimension(:), intent(in) :: R
S(1:5) = Ez(1)*Ey(2)*(Ex(2)*R(1:5) - Ex(3)*R(2:6)) + Ey(3)*Ez(1)*(-Ex(2)*R(8:12)  &
   + Ex(3)*R(9:13))
S(6:9) = Ez(1)*Ey(2)*(Ex(2)*R(8:11) - Ex(3)*R(9:12)) + Ey(3)*Ez(1)*(-Ex(2)*R(14:17)  &
   + Ex(3)*R(15:18))
S(10:12) = Ez(1)*Ey(2)*(Ex(2)*R(14:16) - Ex(3)*R(15:17)) + Ey(3)*Ez(1)*(-Ex(2)*R(19:21)  &
   + Ex(3)*R(20:22))
S(13:14) = Ez(1)*Ey(2)*(Ex(2)*R(19:20) - Ex(3)*R(20:21)) + Ey(3)*Ez(1)*(-Ex(2)*R(23:24)  &
   + Ex(3)*R(24:25))
S(15) = Ez(1)*Ey(2)*(Ex(2)*R(23) - Ex(3)*R(24)) + Ey(3)*Ez(1)*(-Ex(2)*R(26) + Ex(3) &
   *R(27))
S(16:19) = Ez(1)*Ey(2)*(Ex(2)*R(29:32) - Ex(3)*R(30:33)) + Ey(3)*Ez(1)*(-Ex(2)*R(35:38)  &
   + Ex(3)*R(36:39))
S(20:22) = Ez(1)*Ey(2)*(Ex(2)*R(35:37) - Ex(3)*R(36:38)) + Ey(3)*Ez(1)*(-Ex(2)*R(40:42)  &
   + Ex(3)*R(41:43))
S(23:24) = Ez(1)*Ey(2)*(Ex(2)*R(40:41) - Ex(3)*R(41:42)) + Ey(3)*Ez(1)*(-Ex(2)*R(44:45)  &
   + Ex(3)*R(45:46))
S(25) = Ez(1)*Ey(2)*(Ex(2)*R(44) - Ex(3)*R(45)) + Ey(3)*Ez(1)*(-Ex(2)*R(47) + Ex(3) &
   *R(48))
S(26:28) = Ez(1)*Ey(2)*(Ex(2)*R(50:52) - Ex(3)*R(51:53)) + Ey(3)*Ez(1)*(-Ex(2)*R(55:57)  &
   + Ex(3)*R(56:58))
S(29:30) = Ez(1)*Ey(2)*(Ex(2)*R(55:56) - Ex(3)*R(56:57)) + Ey(3)*Ez(1)*(-Ex(2)*R(59:60)  &
   + Ex(3)*R(60:61))
S(31) = Ez(1)*Ey(2)*(Ex(2)*R(59) - Ex(3)*R(60)) + Ey(3)*Ez(1)*(-Ex(2)*R(62) + Ex(3) &
   *R(63))
S(32:33) = Ez(1)*Ey(2)*(Ex(2)*R(65:66) - Ex(3)*R(66:67)) + Ey(3)*Ez(1)*(-Ex(2)*R(69:70)  &
   + Ex(3)*R(70:71))
S(34) = Ez(1)*Ey(2)*(Ex(2)*R(69) - Ex(3)*R(70)) + Ey(3)*Ez(1)*(-Ex(2)*R(72) + Ex(3) &
   *R(73))
S(35) = Ez(1)*Ey(2)*(Ex(2)*R(75) - Ex(3)*R(76)) + Ey(3)*Ez(1)*(-Ex(2)*R(78) + Ex(3) &
   *R(79))
