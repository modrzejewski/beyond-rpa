...
real(F64), dimension(:), intent(in) :: Ez
real(F64), dimension(:), intent(in) :: R
S(1:4) = Ez(1)*Ey(2)*(Ex(4)*R(1:4) - Ex(5)*R(2:5) + Ex(6)*R(3:6)) + Ey(3)*Ez(1)*( &
   -Ex(4)*R(8:11) + Ex(5)*R(9:12) - Ex(6)*R(10:13))
S(5:7) = Ez(1)*Ey(2)*(Ex(4)*R(8:10) - Ex(5)*R(9:11) + Ex(6)*R(10:12)) + Ey(3)*Ez(1) &
   *(-Ex(4)*R(14:16) + Ex(5)*R(15:17) - Ex(6)*R(16:18))
S(8:9) = Ez(1)*Ey(2)*(Ex(4)*R(14:15) - Ex(5)*R(15:16) + Ex(6)*R(16:17)) + Ey(3)*Ez(1) &
   *(-Ex(4)*R(19:20) + Ex(5)*R(20:21) - Ex(6)*R(21:22))
S(10) = Ez(1)*Ey(2)*(Ex(4)*R(19) - Ex(5)*R(20) + Ex(6)*R(21)) + Ey(3)*Ez(1)*(-Ex(4) &
   *R(23) + Ex(5)*R(24) - Ex(6)*R(25))
S(11:13) = Ez(1)*Ey(2)*(Ex(4)*R(29:31) - Ex(5)*R(30:32) + Ex(6)*R(31:33)) + Ey(3) &
   *Ez(1)*(-Ex(4)*R(35:37) + Ex(5)*R(36:38) - Ex(6)*R(37:39))
S(14:15) = Ez(1)*Ey(2)*(Ex(4)*R(35:36) - Ex(5)*R(36:37) + Ex(6)*R(37:38)) + Ey(3) &
   *Ez(1)*(-Ex(4)*R(40:41) + Ex(5)*R(41:42) - Ex(6)*R(42:43))
S(16) = Ez(1)*Ey(2)*(Ex(4)*R(40) - Ex(5)*R(41) + Ex(6)*R(42)) + Ey(3)*Ez(1)*(-Ex(4) &
   *R(44) + Ex(5)*R(45) - Ex(6)*R(46))
S(17:18) = Ez(1)*Ey(2)*(Ex(4)*R(50:51) - Ex(5)*R(51:52) + Ex(6)*R(52:53)) + Ey(3) &
   *Ez(1)*(-Ex(4)*R(55:56) + Ex(5)*R(56:57) - Ex(6)*R(57:58))
S(19) = Ez(1)*Ey(2)*(Ex(4)*R(55) - Ex(5)*R(56) + Ex(6)*R(57)) + Ey(3)*Ez(1)*(-Ex(4) &
   *R(59) + Ex(5)*R(60) - Ex(6)*R(61))
S(20) = Ez(1)*Ey(2)*(Ex(4)*R(65) - Ex(5)*R(66) + Ex(6)*R(67)) + Ey(3)*Ez(1)*(-Ex(4) &
