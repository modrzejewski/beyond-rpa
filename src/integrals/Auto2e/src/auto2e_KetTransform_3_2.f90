...
real(F64), dimension(:), intent(in) :: Ez
real(F64), dimension(:), intent(in) :: R
S(1:4) = Ez(1)*Ey(2)*(Ex(2)*R(1:4) - Ex(3)*R(2:5)) + Ey(3)*Ez(1)*(-Ex(2)*R(7:10)  &
   + Ex(3)*R(8:11))
S(5:7) = Ez(1)*Ey(2)*(Ex(2)*R(7:9) - Ex(3)*R(8:10)) + Ey(3)*Ez(1)*(-Ex(2)*R(12:14)  &
   + Ex(3)*R(13:15))
S(8:9) = Ez(1)*Ey(2)*(Ex(2)*R(12:13) - Ex(3)*R(13:14)) + Ey(3)*Ez(1)*(-Ex(2)*R(16:17)  &
   + Ex(3)*R(17:18))
S(10) = Ez(1)*Ey(2)*(Ex(2)*R(16) - Ex(3)*R(17)) + Ey(3)*Ez(1)*(-Ex(2)*R(19) + Ex(3) &
   *R(20))
S(11:13) = Ez(1)*Ey(2)*(Ex(2)*R(22:24) - Ex(3)*R(23:25)) + Ey(3)*Ez(1)*(-Ex(2)*R(27:29)  &
   + Ex(3)*R(28:30))
S(14:15) = Ez(1)*Ey(2)*(Ex(2)*R(27:28) - Ex(3)*R(28:29)) + Ey(3)*Ez(1)*(-Ex(2)*R(31:32)  &
   + Ex(3)*R(32:33))
S(16) = Ez(1)*Ey(2)*(Ex(2)*R(31) - Ex(3)*R(32)) + Ey(3)*Ez(1)*(-Ex(2)*R(34) + Ex(3) &
   *R(35))
S(17:18) = Ez(1)*Ey(2)*(Ex(2)*R(37:38) - Ex(3)*R(38:39)) + Ey(3)*Ez(1)*(-Ex(2)*R(41:42)  &
   + Ex(3)*R(42:43))
S(19) = Ez(1)*Ey(2)*(Ex(2)*R(41) - Ex(3)*R(42)) + Ey(3)*Ez(1)*(-Ex(2)*R(44) + Ex(3) &
   *R(45))
S(20) = Ez(1)*Ey(2)*(Ex(2)*R(47) - Ex(3)*R(48)) + Ey(3)*Ez(1)*(-Ex(2)*R(50) + Ex(3) &
   *R(51))
