...
real(F64), dimension(:), intent(in) :: Ez
real(F64), dimension(:), intent(in) :: R
S(1:3) = Ez(1)*Ey(2)*(Ex(2)*R(1:3) - Ex(3)*R(2:4)) + Ey(3)*Ez(1)*(-Ex(2)*R(6:8)  &
   + Ex(3)*R(7:9))
S(4:5) = Ez(1)*Ey(2)*(Ex(2)*R(6:7) - Ex(3)*R(7:8)) + Ey(3)*Ez(1)*(-Ex(2)*R(10:11)  &
   + Ex(3)*R(11:12))
S(6) = Ez(1)*Ey(2)*(Ex(2)*R(10) - Ex(3)*R(11)) + Ey(3)*Ez(1)*(-Ex(2)*R(13) + Ex(3) &
   *R(14))
S(7:8) = Ez(1)*Ey(2)*(Ex(2)*R(16:17) - Ex(3)*R(17:18)) + Ey(3)*Ez(1)*(-Ex(2)*R(20:21)  &
   + Ex(3)*R(21:22))
S(9) = Ez(1)*Ey(2)*(Ex(2)*R(20) - Ex(3)*R(21)) + Ey(3)*Ez(1)*(-Ex(2)*R(23) + Ex(3) &
   *R(24))
S(10) = Ez(1)*Ey(2)*(Ex(2)*R(26) - Ex(3)*R(27)) + Ey(3)*Ez(1)*(-Ex(2)*R(29) + Ex(3) &
   *R(30))
