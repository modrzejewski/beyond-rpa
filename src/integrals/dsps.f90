...
contains
      ...
      subroutine ints2e_dsps_perm(shell1, a, shell2, b, shell3, c, shell4, d, &
           gabcd, m1, m2, m3, m4)
            ...
            if (brasum .eq. 2) then
                ...
                call ints2e_dsps(s1(2), a1(2), s1(0), a1(0), &
                ...
                call ints2e_dsps(s1(2), a1(2), s1(0), a1(0), &
                    s2(1), a2(1), s2(0), a2(0), gabcd, 1, 1, 6, 6)
            end if
      end subroutine ints2e_dsps_perm
    

    subroutine ints2e_dsps(shell1, a, shell2, b, shell3, c, shell4, d, gabcd, ka, kb, kc, kd)
            integer, intent(in) :: a, b, c, d
            integer, intent(in) :: shell1, shell2, shell3, shell4
            double precision, dimension(:), intent(out) :: gabcd
