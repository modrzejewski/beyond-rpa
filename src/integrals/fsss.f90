...
contains
      ...
      subroutine ints2e_fsss_perm(shell1, a, shell2, b, shell3, c, shell4, d, gabcd, permutation)
            ...
            case (ERI_SFSS)
                call ints2e_fsss(shell2, b, shell1, a, shell3, c, shell4, d, gabcd)
            case (ERI_SSFS)
                call ints2e_fsss(shell3, c, shell4, d, shell1, a, shell2, b, gabcd)
            case (ERI_SSSF)
                call ints2e_fsss(shell4, d, shell3, c, shell1, a, shell2, b, gabcd)
            case default
                call ints2e_fsss(shell1, a, shell2, b, shell3, c, shell4, d, gabcd)    
            end select

      end subroutine ints2e_fsss_perm
    

    subroutine ints2e_fsss(shell1, a, shell2, b, shell3, c, shell4, d, gabcd)
            integer, intent(in) :: a, b, c, d
            integer, intent(in) :: shell1, shell2, shell3, shell4
            double precision, dimension(:), intent(out) :: gabcd
