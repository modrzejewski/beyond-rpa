...
contains
      ...
      subroutine ints2e_dpds_perm(shell1, a, shell2, b, shell3, c, shell4, d, &
           gabcd, m1, m2, m3, m4)
            ...
            if (brasum .eq. 3) then               
                ...
                if (m1 .eq. 2) then
                    call ints2e_dpds(shell1, a, shell2, b, &
                        s2(2), a2(2), s2(0), a2(0), gabcd, 18, 6, 1, 1)
                else
                    call ints2e_dpds(shell2, b, shell1, a, &
                        s2(2), a2(2), s2(0), a2(0), gabcd, 6, 36, 1, 1)
                end if
            else     
                a2(m1) = a
                s2(m1) = shell1
                ...
                if (m3 .eq. 2) then
                    call ints2e_dpds(shell3, c, shell4, d, &
                        s2(2), a2(2), s2(0), a2(0), gabcd, 3, 1, 18, 18)
                else
                    call ints2e_dpds(shell4, d, shell3, c, &
                        s2(2), a2(2), s2(0), a2(0), gabcd, 1, 6, 18, 18)
                end if
            end if
      end subroutine ints2e_dpds_perm
    

    subroutine ints2e_dpds(shell1, a, shell2, b, shell3, c, shell4, d, gabcd, ka, kb, kc, kd)
            integer, intent(in) :: a, b, c, d
            integer, intent(in) :: shell1, shell2, shell3, shell4
            double precision, dimension(:), intent(out) :: gabcd
