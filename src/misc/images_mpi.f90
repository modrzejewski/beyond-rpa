module images
      ...
      integer, parameter          :: IMG_COMM_ALL = MPI_COMM_WORLD
      !
      ...
      !
      integer, parameter :: IMG_SUM = MPI_SUM
      integer, parameter :: IMG_MAX = MPI_MAX
...
contains
      ...
      subroutine img_itoslaves(message)
            ...
            integer :: nreq
            integer, dimension(MPI_STATUS_SIZE, IMG_NALL) :: stats
