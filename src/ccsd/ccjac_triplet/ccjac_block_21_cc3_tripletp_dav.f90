module ccjac_block_21_cc3_tripletp_dav
use eom_cc3_21_tripletp_trans
use davidson_main
use math_constants
use arithmetic
use cmpidx
implicit none
!
! File generated automatically on 2014-04-05 22:48:44 UTC.
!
contains
subroutine ccjac_21_cc3_tripletp_dav(sigup_diag, sigup_nondiag, t2, nocc0, nocc1, &
...
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_tripletp_trans_aibjak(t2, nocc, nactive, a, i, b, j, k)
...
((a - nvirt0) * (i - 1) * (i - 2)) / 2 + (b - nvirt0) * (i - 1) + j
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_tripletp_trans_aibjbk(t2, nocc, nactive, a, i, b, j, k)
call sigup_nondiag(jac_ibra_iket, ibra, iket) 
...
((a - nvirt0) * (i - 1) * (i - 2)) / 2 + (b - nvirt0) * (i - 1) + j
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_tripletp_trans_aibjcj(t2, nocc, nactive, a, i, b, j, c)
call sigup_nondiag(jac_ibra_iket, ibra, iket) 
...
((a - nvirt0) * (i - 1) * (i - 2)) / 2 + (b - nvirt0) * (i - 1) + j
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_tripletp_trans_aibjci(t2, nocc, nactive, a, i, b, j, c)
call sigup_nondiag(jac_ibra_iket, ibra, iket) 
...
((a - nvirt0) * (i - 1) * (i - 2)) / 2 + (b - nvirt0) * (i - 1) + j
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_tripletp_trans_aibjaj(t2, nocc, nactive, a, i, b, j)
call sigup_nondiag(jac_ibra_iket, ibra, iket) 
...
((a - nvirt0) * (i - 1) * (i - 2)) / 2 + (b - nvirt0) * (i - 1) + j
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_tripletp_trans_aibjai(t2, nocc, nactive, a, i, b, j)
call sigup_nondiag(jac_ibra_iket, ibra, iket) 
...
((a - nvirt0) * (i - 1) * (i - 2)) / 2 + (b - nvirt0) * (i - 1) + j
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_tripletp_trans_aibjbj(t2, nocc, nactive, a, i, b, j)
call sigup_nondiag(jac_ibra_iket, ibra, iket) 
...
((a - nvirt0) * (i - 1) * (i - 2)) / 2 + (b - nvirt0) * (i - 1) + j
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_tripletp_trans_aibjbi(t2, nocc, nactive, a, i, b, j)
call sigup_nondiag(jac_ibra_iket, ibra, iket) 
...
((a - nvirt0) * (i - 1) * (i - 2)) / 2 + (b - nvirt0) * (i - 1) + j
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_tripletp_trans_aibjck(t2, nocc, nactive, a, i, b, j, c, &
 k)
call sigup_nondiag(jac_ibra_iket, ibra, iket) 
...
end subroutine ccjac_21_cc3_tripletp_dav
end module ccjac_block_21_cc3_tripletp_dav
