module ccjac_block_22_tripletmm_dav_part2
...
!
contains
subroutine ccjac_22_tripletmm_dav_part2(sigup_diag, sigup_nondiag, t2, nocc0, nocc1, &
...
integer :: n0ad, n0bc, n0bcd, n0bd, n0cd
integer :: n0ij, n0ik, n0il, n0jk, n0jl
integer :: n0kl
integer :: n1ad, n1bc, n1bcd, n1bd, n1cd
...
if ((n1ik .ge. n0ik))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjcial_abjcl(t2, &
...
nn0a = max(b + 1, n0ad)
nn1a = min(c - 1, n1ad)
if ((nn1a .ge. nn0a))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjcial_ibjcl(t2, &
...
nn0a = max(b + 1, n0ad)
nn1a = min(c - 1, n1ad)
if ((nn1a .ge. nn0a))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibickal_ibckl(t2, &
...
nn0a = max(b + 1, n0ad)
nn1a = min(c - 1, n1ad)
if ((n1il .ge. n0il).and. (nn1a .ge. nn0a))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjckai_bjck(t2, &
...
nn0a = max(b + 1, n0ad)
nn1a = min(c - 1, n1ad)
if ((nn1a .ge. nn0a))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjckai_ibjck(t2, &
...
if ((n1il .ge. n0il))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjckai_abjck(t2, &
...
nn0a = max(b + 1, n0ad)
nn1a = min(c - 1, n1ad)
if ((n1jk .ge. n0jk).and. (nn1a .ge. nn0a))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjcjal_ibcl(t2, &
...
nn0a = max(b + 1, n0ad)
nn1a = min(c - 1, n1ad)
if ((nn1a .ge. nn0a))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjcjal_ibjcl(t2, &
 nocc, nactive, i, b, j, c, l)
a0 = max(b + 1, n0ad)
a1 = min(c - 1, n1ad)
...
if ((n1jk .ge. n0jk))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjcjal_aibcl(t2, &
...
nn0a = max(b + 1, n0ad)
nn1a = min(c - 1, n1ad)
if ((nn1a .ge. nn0a))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjckak_ibjck(t2, &
 nocc, nactive, i, b, j, c, k)
a0 = max(b + 1, n0ad)
a1 = min(c - 1, n1ad)
...
nn0a = max(b + 1, n0ad)
nn1a = min(c - 1, n1ad)
if ((nn1a .ge. nn0a))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjckaj_ibjck(t2, &
 nocc, nactive, i, b, j, c, k)
a0 = max(b + 1, n0ad)
a1 = min(c - 1, n1ad)
...
if ((n1jl .ge. n0jl))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjckaj_aibck(t2, &
...
jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjbkbl_aibjkl(t2, nocc, nactive, a, &
 i, b, j, k, l)
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
...
if ((n1ik .ge. n0ik))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjbidl_abjdl(t2, &
...
nn0b = max(d + 1, n0bc)
nn1b = min(a - 1, n1bc)
if ((nn1b .ge. nn0b))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjbidl_aijdl(t2, &
...
nn0b = max(d + 1, n0bc)
nn1b = min(a - 1, n1bc)
if ((nn1b .ge. nn0b))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibibkdl_aikdl(t2, &
...
nn0b = max(d + 1, n0bc)
nn1b = min(a - 1, n1bc)
if ((nn1b .ge. nn0b).and. (n1il .ge. n0il))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjbkdi_ajkd(t2, &
...
if ((n1il .ge. n0il))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjbkdi_abjkd(t2, &
...
nn0b = max(d + 1, n0bc)
nn1b = min(a - 1, n1bc)
if ((nn1b .ge. nn0b))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjbkdi_aijkd(t2, &
...
nn0b = max(d + 1, n0bc)
nn1b = min(a - 1, n1bc)
if ((n1jk .ge. n0jk).and. (nn1b .ge. nn0b))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjbjdl_aidl(t2, &
...
nn0b = max(d + 1, n0bc)
nn1b = min(a - 1, n1bc)
if ((nn1b .ge. nn0b))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjbjdl_aijdl(t2, &
 nocc, nactive, a, i, j, d, l)
b0 = max(d + 1, n0bc)
b1 = min(a - 1, n1bc)
...
if ((n1jk .ge. n0jk))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjbjdl_aibdl(t2, &
...
nn0b = max(d + 1, n0bc)
nn1b = min(a - 1, n1bc)
if ((nn1b .ge. nn0b))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjbkdk_aijkd(t2, &
 nocc, nactive, a, i, j, k, d)
b0 = max(d + 1, n0bc)
b1 = min(a - 1, n1bc)
...
nn0b = max(d + 1, n0bc)
nn1b = min(a - 1, n1bc)
if ((nn1b .ge. nn0b))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjbkdj_aijkd(t2, &
 nocc, nactive, a, i, j, k, d)
b0 = max(d + 1, n0bc)
b1 = min(a - 1, n1bc)
...
if ((n1jl .ge. n0jl))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjbkdj_aibkd(t2, &
...
nn0i = max(l + 1, n0ik)
if ((n1ik .ge. nn0i))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjcicl_abjcl(t2, &
 nocc, nactive, a, b, j, c, l)
i0 = max(l + 1, n0ik)
...
nn1i = min(k - 1, n1il)
if ((nn1i .ge. n0il))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjckci_abjck(t2, &
 nocc, nactive, a, b, j, c, k)
i1 = min(k - 1, n1il)
...
nn0j = max(l + 1, n0jk)
if ((n1jk .ge. nn0j))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjcjcl_aibcl(t2, &
 nocc, nactive, a, i, b, c, l)
j0 = max(l + 1, n0jk)
...
nn1j = min(k - 1, n1jl)
if ((nn1j .ge. n0jl))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjckcj_aibck(t2, &
 nocc, nactive, a, i, b, c, k)
j1 = min(k - 1, n1jl)
...
if ((nn1b .ge. n0bd).and. (n1ik .ge. n0ik))jac_ibra_iket = eom_ccsd_22_tripletmm_trans_aibjcibl_ajcl(t2, &
...
end subroutine ccjac_22_tripletmm_dav_part2
end module ccjac_block_22_tripletmm_dav_part2
