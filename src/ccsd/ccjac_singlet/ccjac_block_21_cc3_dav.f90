...
implicit none
!
! File generated automatically on 2019-06-13 16:51:48 UTC.
!
contains
subroutine ccjac_21_cc3_dav(sigup_diag, sigup_nondiag, t2, nocc0, nocc1, nvirt0, &
...
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aiajck(t2, nocc, nactive, a, i, j, c, k)
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aibjak(t2, nocc, nactive, a, i, b, j, k)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibjak
end do a_aibjak
end do j_aibjak
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aibjbk(t2, nocc, nactive, a, i, b, j, k)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibjbk
end do a_aibjbk
end do j_aibjbk
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aibick(t2, nocc, nactive, a, i, b, c, k)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibick
end do a_aibick
end do b_aibick
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aibjci(t2, nocc, nactive, a, i, b, j, c)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibjci
end do a_aibjci
end do j_aibjci
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aibjcj(t2, nocc, nactive, a, i, b, j, c)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibjcj
end do a_aibjcj
end do j_aibjcj
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aiajak(t2, nocc, nactive, a, i, j, k)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aiajak
end do a_aiajak
end do j_aiajak
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aiaick(t2, nocc, nactive, a, i, c, k)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aiaick
end do a_aiaick
end do k_aiaick
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aiajci(t2, nocc, nactive, a, i, j, c)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aiajci
end do a_aiajci
end do j_aiajci
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aiajcj(t2, nocc, nactive, a, i, j, c)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aiajcj
end do a_aiajcj
end do j_aiajcj
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aibiak(t2, nocc, nactive, a, i, b, k)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibiak
end do a_aibiak
end do b_aibiak
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aibjai(t2, nocc, nactive, a, i, b, j)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibjai
end do a_aibjai
end do j_aibjai
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aibjaj(t2, nocc, nactive, a, i, b, j)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibjaj
end do a_aibjaj
end do j_aibjaj
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aibibk(t2, nocc, nactive, a, i, b, k)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibibk
end do a_aibibk
end do b_aibibk
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aibjbi(t2, nocc, nactive, a, i, b, j)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibjbi
end do a_aibjbi
end do j_aibjbi
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aibjbj(t2, nocc, nactive, a, i, b, j)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibjbj
end do a_aibjbj
end do j_aibjbj
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aibici(t2, nocc, nactive, a, i, b, c)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibici
end do a_aibici
end do b_aibici
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aiaiak(t2, nocc, nactive, a, i, k)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aiaiak
end do a_aiaiak
end do k_aiaiak
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aiajai(t2, nocc, nactive, a, i, j)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aiajai
end do a_aiajai
end do j_aiajai
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aiajaj(t2, nocc, nactive, a, i, j)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aiajaj
end do a_aiajaj
end do j_aiajaj
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aiaici(t2, nocc, nactive, a, i, c)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aiaici
end do a_aiaici
end do c_aiaici
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aibiai(t2, nocc, nactive, a, i, b)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibiai
end do a_aibiai
end do b_aibiai
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aibibi(t2, nocc, nactive, a, i, b)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibibi
end do a_aibibi
end do b_aibibi
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aiaiai(t2, nocc, nactive, a, i)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aiaiai
end do a_aiaiai
!
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
jac_ibra_iket = eom_cc3_21_trans_aibjck(t2, nocc, nactive, a, i, b, j, c, k)
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibjck
end do a_aibjck
end do j_aibjck
...
end subroutine ccjac_21_cc3_dav
end module ccjac_block_21_cc3_dav
