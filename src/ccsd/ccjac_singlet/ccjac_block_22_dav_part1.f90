module ccjac_block_22_dav_part1
...
!
contains
subroutine ccjac_22_dav_part1(sigup_diag, sigup_nondiag, t2, nocc0, nocc1, nvirt0, &
...
if ((n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjakdl_ibjkdl(t2, nocc, &
 nactive, i, b, j, k, d, l)
a0 = max(b + 1, d + 1, n0ac)
...
nn0a = max(b + 1, n0ad)
nn1a = min(c - 1, n1ad)
if ((nn1a .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjckal_ibjckl(t2, nocc, &
 nactive, i, b, j, c, k, l)
a0 = max(b + 1, n0ad)
a1 = min(c - 1, n1ad)
...
nn0b = max(d + 1, n0bc)
nn1b = min(a - 1, n1bc)
if ((nn1b .ge. nn0b))jac_ibra_iket = eom_ccsd_22_trans_aibjbkdl_aijkdl(t2, nocc, &
 nactive, a, i, j, k, d, l)
b0 = max(d + 1, n0bc)
b1 = min(a - 1, n1bc)
...
if ((nn1b .ge. n0bd))jac_ibra_iket = eom_ccsd_22_trans_aibjckbl_aijckl(t2, nocc, &
 nactive, a, i, j, c, k, l)
b1 = min(a - 1, c - 1, n1bd)
...
if ((n1ik .ge. n0ik))jac_ibra_iket = eom_ccsd_22_trans_aibjcidl_abjcdl(t2, nocc, &
 nactive, a, b, j, c, d, l)
...
if ((n1il .ge. n0il))jac_ibra_iket = eom_ccsd_22_trans_aibjckdi_abjckd(t2, nocc, &
 nactive, a, b, j, c, k, d)
...
if ((n1jk .ge. n0jk))jac_ibra_iket = eom_ccsd_22_trans_aibjcjdl_aibcdl(t2, nocc, &
 nactive, a, i, b, c, d, l)
...
if ((n1jl .ge. n0jl))jac_ibra_iket = eom_ccsd_22_trans_aibjckdj_aibckd(t2, nocc, &
 nactive, a, i, b, c, k, d)
...
jac_ibra_iket = eom_ccsd_22_trans_aiajakdl_aijkdl(t2, nocc, nactive, a, i, j, k, &
 d, l)
...
jac_ibra_iket = eom_ccsd_22_trans_aibjakal_aibjkl(t2, nocc, nactive, a, i, b, j, &
 k, l)
ck = (a - nvirt0) * nocc + (k - nocc0) + 1
dl = (a - nvirt0) * nocc + (l - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
...
if ((n1bd .ge. n0bd).and. (n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjakbl_ijkl(t2, &
...
nn1b = min(a - 1, n1bd)
if ((nn1b .ge. n0bd))jac_ibra_iket = eom_ccsd_22_trans_aibjakbl_aijkl(t2, nocc, nactive, &
 a, i, j, k, l)
b1 = min(a - 1, n1bd)
...
nn0a = max(b + 1, n0ac)
if ((n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjakbl_ibjkl(t2, nocc, nactive, &
 i, b, j, k, l)
a0 = max(b + 1, n0ac)
...
nn0a = max(b + 1, d + 1, n0ac)
if ((n1ik .ge. n0ik).and. (n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjaidl_bjdl(t2, &
...
nn0a = max(b + 1, d + 1, n0ac)
if ((n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjaidl_ibjdl(t2, nocc, nactive, &
 i, b, j, d, l)
a0 = max(b + 1, d + 1, n0ac)
...
if ((n1ik .ge. n0ik))jac_ibra_iket = eom_ccsd_22_trans_aibjaidl_abjdl(t2, nocc, nactive, &
 a, b, j, d, l)
...
nn0a = max(b + 1, d + 1, n0ac)
if ((n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibiakdl_ibkdl(t2, nocc, nactive, &
 i, b, k, d, l)
a0 = max(b + 1, d + 1, n0ac)
...
nn0a = max(b + 1, d + 1, n0ac)
if ((n1il .ge. n0il).and. (n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjakdi_bjkd(t2, &
 nocc, nactive, b, j, k, d)
a0 = max(b + 1, d + 1, n0ac)
a_aibjakdi_bjkd: do a = a0, n1ac
if (a == b .or. a == d) cycle a_aibjakdi_bjkd
i_aibjakdi_bjkd: do i = n0il, n1il
...
nn0a = max(b + 1, d + 1, n0ac)
if ((n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjakdi_ibjkd(t2, nocc, nactive, &
 i, b, j, k, d)
a0 = max(b + 1, d + 1, n0ac)
...
if ((n1il .ge. n0il))jac_ibra_iket = eom_ccsd_22_trans_aibjakdi_abjkd(t2, nocc, nactive, &
 a, b, j, k, d)
...
nn0a = max(b + 1, d + 1, n0ac)
if ((n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjajdl_ibjdl(t2, nocc, nactive, &
 i, b, j, d, l)
a0 = max(b + 1, d + 1, n0ac)
...
if ((n1jk .ge. n0jk))jac_ibra_iket = eom_ccsd_22_trans_aibjajdl_aibdl(t2, nocc, nactive, &
 a, i, b, d, l)
...
nn0a = max(b + 1, d + 1, n0ac)
if ((n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjakdk_ibjkd(t2, nocc, nactive, &
 i, b, j, k, d)
a0 = max(b + 1, d + 1, n0ac)
...
nn0a = max(b + 1, d + 1, n0ac)
if ((n1jl .ge. n0jl).and. (n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjakdj_ibkd(t2, &
...
nn0a = max(b + 1, d + 1, n0ac)
if ((n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjakdj_ibjkd(t2, nocc, nactive, &
 i, b, j, k, d)
a0 = max(b + 1, d + 1, n0ac)
...
if ((n1jl .ge. n0jl))jac_ibra_iket = eom_ccsd_22_trans_aibjakdj_aibkd(t2, nocc, nactive, &
 a, i, b, k, d)
...
jac_ibra_iket = eom_ccsd_22_trans_aiajckal_aijckl(t2, nocc, nactive, a, i, j, c, &
 k, l)
bj = (a - nvirt0) * nocc + (j - nocc0) + 1
dl = (a - nvirt0) * nocc + (l - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
...
nn0i = max(j + 1, n0ik)
if ((n1ik .ge. nn0i))jac_ibra_iket = eom_ccsd_22_trans_aiajcidl_ajcdl(t2, nocc, nactive, &
 a, j, c, d, l)
i0 = max(j + 1, n0ik)
...
nn0i = max(j + 1, n0il)
if ((n1il .ge. nn0i))jac_ibra_iket = eom_ccsd_22_trans_aiajckdi_ajckd(t2, nocc, nactive, &
 a, j, c, k, d)
i0 = max(j + 1, n0il)
...
nn1j = min(i - 1, n1jk)
if ((nn1j .ge. n0jk))jac_ibra_iket = eom_ccsd_22_trans_aiajcjdl_aicdl(t2, nocc, nactive, &
 a, i, c, d, l)
j1 = min(i - 1, n1jk)
...
end subroutine ccjac_22_dav_part1
end module ccjac_block_22_dav_part1
