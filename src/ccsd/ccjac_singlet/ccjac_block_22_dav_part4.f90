module ccjac_block_22_dav_part4
...
!
contains
subroutine ccjac_22_dav_part4(sigup_diag, sigup_nondiag, t2, nocc0, nocc1, nvirt0, &
...
nn0i = max(j + 1, n0il)
if ((n1il .ge. nn0i))jac_ibra_iket = eom_ccsd_22_trans_aiajakdi_ajkd(t2, nocc, nactive, &
 a, j, k, d)
i0 = max(j + 1, n0il)
...
jac_ibra_iket = eom_ccsd_22_trans_aiajakdi_aijkd(t2, nocc, nactive, a, i, j, k, d)
bj = (a - nvirt0) * nocc + (j - nocc0) + 1
ck = (a - nvirt0) * nocc + (k - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
dl = (d - nvirt0) * nocc + (i - nocc0) + 1
...
nn1j = min(i - 1, n1jk)
if ((nn1j .ge. n0jk))jac_ibra_iket = eom_ccsd_22_trans_aiajajdl_aidl(t2, nocc, nactive, &
 a, i, d, l)
j1 = min(i - 1, n1jk)
...
jac_ibra_iket = eom_ccsd_22_trans_aiajajdl_aijdl(t2, nocc, nactive, a, i, j, d, l)
bj = (a - nvirt0) * nocc + (j - nocc0) + 1
ck = (a - nvirt0) * nocc + (j - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
dl = (d - nvirt0) * nocc + (l - nocc0) + 1
...
jac_ibra_iket = eom_ccsd_22_trans_aiajakdk_aijkd(t2, nocc, nactive, a, i, j, k, d)
bj = (a - nvirt0) * nocc + (j - nocc0) + 1
ck = (a - nvirt0) * nocc + (k - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
...
nn1j = min(i - 1, n1jl)
if ((nn1j .ge. n0jl))jac_ibra_iket = eom_ccsd_22_trans_aiajakdj_aikd(t2, nocc, nactive, &
 a, i, k, d)
j1 = min(i - 1, n1jl)
...
jac_ibra_iket = eom_ccsd_22_trans_aiajakdj_aijkd(t2, nocc, nactive, a, i, j, k, d)
bj = (a - nvirt0) * nocc + (j - nocc0) + 1
ck = (a - nvirt0) * nocc + (k - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
dl = (d - nvirt0) * nocc + (j - nocc0) + 1
...
nn0i = max(l + 1, n0ik)
if ((n1ik .ge. nn0i))jac_ibra_iket = eom_ccsd_22_trans_aibjaial_abjl(t2, nocc, nactive, &
 a, b, j, l)
i0 = max(l + 1, n0ik)
...
jac_ibra_iket = eom_ccsd_22_trans_aibjaial_aibjl(t2, nocc, nactive, a, i, b, j, l)
dl = (a - nvirt0) * nocc + (l - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
ck = (a - nvirt0) * nocc + (i - nocc0) + 1
bj = (b - nvirt0) * nocc + (j - nocc0) + 1
...
jac_ibra_iket = eom_ccsd_22_trans_aibiakal_aibkl(t2, nocc, nactive, a, i, b, k, l)
ck = (a - nvirt0) * nocc + (k - nocc0) + 1
dl = (a - nvirt0) * nocc + (l - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
...
nn1i = min(k - 1, n1il)
if ((nn1i .ge. n0il))jac_ibra_iket = eom_ccsd_22_trans_aibjakai_abjk(t2, nocc, nactive, &
 a, b, j, k)
i1 = min(k - 1, n1il)
...
jac_ibra_iket = eom_ccsd_22_trans_aibjakai_aibjk(t2, nocc, nactive, a, i, b, j, k)
ck = (a - nvirt0) * nocc + (k - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
dl = (a - nvirt0) * nocc + (i - nocc0) + 1
bj = (b - nvirt0) * nocc + (j - nocc0) + 1
...
nn0j = max(l + 1, n0jk)
if ((n1jk .ge. nn0j))jac_ibra_iket = eom_ccsd_22_trans_aibjajal_aibl(t2, nocc, nactive, &
 a, i, b, l)
j0 = max(l + 1, n0jk)
...
jac_ibra_iket = eom_ccsd_22_trans_aibjajal_aibjl(t2, nocc, nactive, a, i, b, j, l)
ck = (a - nvirt0) * nocc + (j - nocc0) + 1
dl = (a - nvirt0) * nocc + (l - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
bj = (b - nvirt0) * nocc + (j - nocc0) + 1
...
! No equalities independent of the above can hold.
!
k_aibjakak_aibjk: do k = n0kl, n1kl
b_aibjakak_aibjk: do b = n0b, n1b
j_aibjakak_aibjk: do j = n0j, n1j
if (j == k) cycle j_aibjakak_aibjk
a0 = max(b + 1, n0acd)
a_aibjakak_aibjk: do a = a0, n1acd
if (a == b) cycle a_aibjakak_aibjk
i_aibjakak_aibjk: do i = n0i, n1i
if (i == j .or. i == k) cycle i_aibjakak_aibjk
jac_ibra_iket = eom_ccsd_22_trans_aibjakak_aibjk(t2, nocc, nactive, a, i, b, j, k)
ck = (a - nvirt0) * nocc + (k - nocc0) + 1
...
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aibjakak_aibjk
end do a_aibjakak_aibjk
end do j_aibjakak_aibjk
end do b_aibjakak_aibjk
end do k_aibjakak_aibjk
!
! Elementary loop  16
! --------------------
! Free virtual indices: a, b
...
nn1j = min(k - 1, n1jl)
if ((nn1j .ge. n0jl))jac_ibra_iket = eom_ccsd_22_trans_aibjakaj_aibk(t2, nocc, nactive, &
 a, i, b, k)
j1 = min(k - 1, n1jl)
...
jac_ibra_iket = eom_ccsd_22_trans_aibjakaj_aibjk(t2, nocc, nactive, a, i, b, j, k)
ck = (a - nvirt0) * nocc + (k - nocc0) + 1
dl = (a - nvirt0) * nocc + (j - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
bj = (b - nvirt0) * nocc + (j - nocc0) + 1
...
if ((n1bd .ge. n0bd).and. (n1ik .ge. n0ik).and. (n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjaibl_jl(t2, &
 nocc, nactive, j, l)
...
nn1b = min(a - 1, n1bd)
if ((nn1b .ge. n0bd).and. (n1ik .ge. n0ik))jac_ibra_iket = eom_ccsd_22_trans_aibjaibl_ajl(t2, &
 nocc, nactive, a, j, l)
b1 = min(a - 1, n1bd)
...
nn0a = max(b + 1, n0ac)
if ((n1ik .ge. n0ik).and. (n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjaibl_bjl(t2, &
 nocc, nactive, b, j, l)
a0 = max(b + 1, n0ac)
...
nn0a = max(n0bd + 1, n0ac)
if ((n1bd .ge. n0bd).and. (n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjaibl_ijl(t2, &
 nocc, nactive, i, j, l)
...
nn1b = min(a - 1, n1bd)
if ((nn1b .ge. n0bd))jac_ibra_iket = eom_ccsd_22_trans_aibjaibl_aijl(t2, nocc, nactive, &
 a, i, j, l)
b1 = min(a - 1, n1bd)
...
nn0a = max(b + 1, n0ac)
if ((n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjaibl_ibjl(t2, nocc, nactive, &
 i, b, j, l)
a0 = max(b + 1, n0ac)
...
if ((n1ik .ge. n0ik))jac_ibra_iket = eom_ccsd_22_trans_aibjaibl_abjl(t2, nocc, nactive, &
 a, b, j, l)
...
nn0a = max(n0bd + 1, n0ac)
if ((n1bd .ge. n0bd).and. (n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibiakbl_ikl(t2, &
 nocc, nactive, i, k, l)
...
nn1b = min(a - 1, n1bd)
if ((nn1b .ge. n0bd))jac_ibra_iket = eom_ccsd_22_trans_aibiakbl_aikl(t2, nocc, nactive, &
 a, i, k, l)
b1 = min(a - 1, n1bd)
...
nn0a = max(b + 1, n0ac)
if ((n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibiakbl_ibkl(t2, nocc, nactive, &
 i, b, k, l)
a0 = max(b + 1, n0ac)
...
nn0a = max(n0bd + 1, n0ac)
if ((n1bd .ge. n0bd).and. (n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjakbi_ijk(t2, &
 nocc, nactive, i, j, k)
...
nn0a = max(b + 1, n0ac)
if ((n1il .ge. n0il).and. (n1ac .ge. nn0a))jac_ibra_iket = eom_ccsd_22_trans_aibjakbi_bjk(t2, &
 nocc, nactive, b, j, k)
a0 = max(b + 1, n0ac)
a_aibjakbi_bjk: do a = a0, n1ac
if (a == b) cycle a_aibjakbi_bjk
i_aibjakbi_bjk: do i = n0il, n1il
...
nn1b = min(a - 1, n1bd)
if ((nn1b .ge. n0bd))jac_ibra_iket = eom_ccsd_22_trans_aibjakbi_aijk(t2, nocc, nactive, &
 a, i, j, k)
b1 = min(a - 1, n1bd)
...
end subroutine ccjac_22_dav_part4
end module ccjac_block_22_dav_part4
