module ccjac_block_22_dav_part10
...
!
contains
subroutine ccjac_22_dav_part10(sigup_diag, sigup_nondiag, t2, nocc0, nocc1, nvirt0, &
...
integer :: i, j, k, l
integer :: ai, bj, ck, dl
integer :: nn0a, nn0i, nn0j, nn0k, nn1i, nn1j
integer :: a0, i0, i1, j0, j1, k0
integer :: n0abc, n0abcd, n0ij, n0ijk, n0ijl
integer :: n0ik, n0ikl, n0il, n0jk, n0jkl
integer :: n0jl, n0kl
integer :: n1abc, n1abcd, n1ij, n1ijk, n1ijl
...
jac_ibra_iket = eom_ccsd_22_trans_aiajaial_aijl(t2, nocc, nactive, a, i, j, l)
...
! No equalities independent of the above can hold.
!
l_aiaiakal_ikl: do l = n0l, n1l
k0 = max(l + 1, n0k)
k_aiaiakal_ikl: do k = k0, n1k
if (k == l) cycle k_aiaiakal_ikl
i_aiaiakal_ikl: do i = n0ij, n1ij
if (i == k .or. i == l) cycle i_aiaiakal_ikl
if ((n1abcd .ge. n0abcd))jac_ibra_iket = eom_ccsd_22_trans_aiaiakal_ikl(t2, nocc, &
 nactive, i, k, l)
a_aiaiakal_ikl: do a = n0abcd, n1abcd
...
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do a_aiaiakal_ikl
end do i_aiaiakal_ikl
end do k_aiaiakal_ikl
end do l_aiaiakal_ikl
!
! Elementary loop  3
! --------------------
! Free virtual indices: a
...
! No equalities independent of the above can hold.
!
l_aiaiakal_aikl: do l = n0l, n1l
k0 = max(l + 1, n0k)
k_aiaiakal_aikl: do k = k0, n1k
if (k == l) cycle k_aiaiakal_aikl
a_aiaiakal_aikl: do a = n0abcd, n1abcd
i_aiaiakal_aikl: do i = n0ij, n1ij
if (i == k .or. i == l) cycle i_aiaiakal_aikl
jac_ibra_iket = eom_ccsd_22_trans_aiaiakal_aikl(t2, nocc, nactive, a, i, k, l)
ck = (a - nvirt0) * nocc + (k - nocc0) + 1
dl = (a - nvirt0) * nocc + (l - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
bj = (a - nvirt0) * nocc + (i - nocc0) + 1
...
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aiaiakal_aikl
end do a_aiaiakal_aikl
end do k_aiaiakal_aikl
end do l_aiaiakal_aikl
!
! Elementary loop  4
! --------------------
! Free virtual indices: a
...
nn0i = max(j + 1, n0il)
nn1i = min(k - 1, n1il)
if ((nn1i .ge. nn0i).and. (n1abcd .ge. n0abcd))jac_ibra_iket = eom_ccsd_22_trans_aiajakai_jk(t2, &
 nocc, nactive, j, k)
...
nn0i = max(j + 1, n0il)
nn1i = min(k - 1, n1il)
if ((nn1i .ge. nn0i))jac_ibra_iket = eom_ccsd_22_trans_aiajakai_ajk(t2, nocc, nactive, &
 a, j, k)
i0 = max(j + 1, n0il)
i1 = min(k - 1, n1il)
...
if ((n1abcd .ge. n0abcd))jac_ibra_iket = eom_ccsd_22_trans_aiajakai_ijk(t2, nocc, &
 nactive, i, j, k)
...
jac_ibra_iket = eom_ccsd_22_trans_aiajakai_aijk(t2, nocc, nactive, a, i, j, k)
bj = (a - nvirt0) * nocc + (j - nocc0) + 1
ck = (a - nvirt0) * nocc + (k - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
dl = (a - nvirt0) * nocc + (i - nocc0) + 1
...
nn0j = max(l + 1, n0jk)
nn1j = min(i - 1, n1jk)
if ((nn1j .ge. nn0j).and. (n1abcd .ge. n0abcd))jac_ibra_iket = eom_ccsd_22_trans_aiajajal_il(t2, &
 nocc, nactive, i, l)
j0 = max(l + 1, n0jk)
j1 = min(i - 1, n1jk)
...
nn0j = max(l + 1, n0jk)
nn1j = min(i - 1, n1jk)
if ((nn1j .ge. nn0j))jac_ibra_iket = eom_ccsd_22_trans_aiajajal_ail(t2, nocc, nactive, &
 a, i, l)
j0 = max(l + 1, n0jk)
j1 = min(i - 1, n1jk)
...
if ((n1abcd .ge. n0abcd))jac_ibra_iket = eom_ccsd_22_trans_aiajajal_ijl(t2, nocc, &
 nactive, i, j, l)
...
jac_ibra_iket = eom_ccsd_22_trans_aiajajal_aijl(t2, nocc, nactive, a, i, j, l)
bj = (a - nvirt0) * nocc + (j - nocc0) + 1
ck = (a - nvirt0) * nocc + (j - nocc0) + 1
dl = (a - nvirt0) * nocc + (l - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
...
! No equalities independent of the above can hold.
!
k_aiajakak_ijk: do k = n0kl, n1kl
j_aiajakak_ijk: do j = n0j, n1j
if (j == k) cycle j_aiajakak_ijk
i0 = max(j + 1, n0i)
i_aiajakak_ijk: do i = i0, n1i
if (i == j .or. i == k) cycle i_aiajakak_ijk
if ((n1abcd .ge. n0abcd))jac_ibra_iket = eom_ccsd_22_trans_aiajakak_ijk(t2, nocc, &
 nactive, i, j, k)
a_aiajakak_ijk: do a = n0abcd, n1abcd
bj = (a - nvirt0) * nocc + (j - nocc0) + 1
ck = (a - nvirt0) * nocc + (k - nocc0) + 1
...
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do a_aiajakak_ijk
end do i_aiajakak_ijk
end do j_aiajakak_ijk
end do k_aiajakak_ijk
!
! Elementary loop  13
! --------------------
! Free virtual indices: a
...
! No equalities independent of the above can hold.
!
k_aiajakak_aijk: do k = n0kl, n1kl
j_aiajakak_aijk: do j = n0j, n1j
if (j == k) cycle j_aiajakak_aijk
a_aiajakak_aijk: do a = n0abcd, n1abcd
i0 = max(j + 1, n0i)
i_aiajakak_aijk: do i = i0, n1i
if (i == j .or. i == k) cycle i_aiajakak_aijk
jac_ibra_iket = eom_ccsd_22_trans_aiajakak_aijk(t2, nocc, nactive, a, i, j, k)
bj = (a - nvirt0) * nocc + (j - nocc0) + 1
ck = (a - nvirt0) * nocc + (k - nocc0) + 1
dl = (a - nvirt0) * nocc + (k - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
...
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aiajakak_aijk
end do a_aiajakak_aijk
end do j_aiajakak_aijk
end do k_aiajakak_aijk
!
! Elementary loop  14
! --------------------
! Free virtual indices: a
...
if ((nn1j .ge. n0jl).and. (n1abcd .ge. n0abcd))jac_ibra_iket = eom_ccsd_22_trans_aiajakaj_ik(t2, &
 nocc, nactive, i, k)
j1 = min(i - 1, k - 1, n1jl)
...
nn1j = min(i - 1, k - 1, n1jl)
if ((nn1j .ge. n0jl))jac_ibra_iket = eom_ccsd_22_trans_aiajakaj_aik(t2, nocc, nactive, &
 a, i, k)
j1 = min(i - 1, k - 1, n1jl)
...
if ((n1abcd .ge. n0abcd))jac_ibra_iket = eom_ccsd_22_trans_aiajakaj_ijk(t2, nocc, &
 nactive, i, j, k)
...
jac_ibra_iket = eom_ccsd_22_trans_aiajakaj_aijk(t2, nocc, nactive, a, i, j, k)
bj = (a - nvirt0) * nocc + (j - nocc0) + 1
ck = (a - nvirt0) * nocc + (k - nocc0) + 1
dl = (a - nvirt0) * nocc + (j - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
...
! No equalities independent of the above can hold.
!
d_aiaiaidl_aidl: do d = n0d, n1d
l_aiaiaidl_aidl: do l = n0l, n1l
a0 = max(d + 1, n0abc)
a_aiaiaidl_aidl: do a = a0, n1abc
if (a == d) cycle a_aiaiaidl_aidl
i_aiaiaidl_aidl: do i = n0ijk, n1ijk
if (i == l) cycle i_aiaiaidl_aidl
jac_ibra_iket = eom_ccsd_22_trans_aiaiaidl_aidl(t2, nocc, nactive, a, i, d, l)
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
bj = (a - nvirt0) * nocc + (i - nocc0) + 1
ck = (a - nvirt0) * nocc + (i - nocc0) + 1
...
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aiaiaidl_aidl
end do a_aiaiaidl_aidl
end do l_aiaiaidl_aidl
end do d_aiaiaidl_aidl
!
! Elementary loop  19
! --------------------
! Free virtual indices: a, d
...
jac_ibra_iket = eom_ccsd_22_trans_aiajaidi_aijd(t2, nocc, nactive, a, i, j, d)
bj = (a - nvirt0) * nocc + (j - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
ck = (a - nvirt0) * nocc + (i - nocc0) + 1
...
if ((n1jl .ge. n0jl).and. (n1ik .ge. nn0i))jac_ibra_iket = eom_ccsd_22_trans_aiajaidj_ad(t2, &
 nocc, nactive, a, d)
...
nn1j = min(i - 1, n1jl)
if ((nn1j .ge. n0jl))jac_ibra_iket = eom_ccsd_22_trans_aiajaidj_aid(t2, nocc, nactive, &
 a, i, d)
j1 = min(i - 1, n1jl)
...
nn0i = max(j + 1, n0ik)
if ((n1ik .ge. nn0i))jac_ibra_iket = eom_ccsd_22_trans_aiajaidj_ajd(t2, nocc, nactive, &
 a, j, d)
i0 = max(j + 1, n0ik)
...
jac_ibra_iket = eom_ccsd_22_trans_aiajaidj_aijd(t2, nocc, nactive, a, i, j, d)
bj = (a - nvirt0) * nocc + (j - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
ck = (a - nvirt0) * nocc + (i - nocc0) + 1
dl = (d - nvirt0) * nocc + (j - nocc0) + 1
...
! No equalities independent of the above can hold.
!
d_aiaiakdi_aikd: do d = n0d, n1d
k_aiaiakdi_aikd: do k = n0k, n1k
a0 = max(d + 1, n0abc)
a_aiaiakdi_aikd: do a = a0, n1abc
if (a == d) cycle a_aiaiakdi_aikd
i_aiaiakdi_aikd: do i = n0ijl, n1ijl
if (i == k) cycle i_aiaiakdi_aikd
jac_ibra_iket = eom_ccsd_22_trans_aiaiakdi_aikd(t2, nocc, nactive, a, i, k, d)
ck = (a - nvirt0) * nocc + (k - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
bj = (a - nvirt0) * nocc + (i - nocc0) + 1
dl = (d - nvirt0) * nocc + (i - nocc0) + 1
...
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aiaiakdi_aikd
end do a_aiaiakdi_aikd
end do k_aiaiakdi_aikd
end do d_aiaiakdi_aikd
!
! Elementary loop  25
! --------------------
! Free virtual indices: a, d
...
! No equalities independent of the above can hold.
!
d_aiaiakdk_aikd: do d = n0d, n1d
k_aiaiakdk_aikd: do k = n0kl, n1kl
a0 = max(d + 1, n0abc)
a_aiaiakdk_aikd: do a = a0, n1abc
if (a == d) cycle a_aiaiakdk_aikd
i_aiaiakdk_aikd: do i = n0ij, n1ij
if (i == k) cycle i_aiaiakdk_aikd
jac_ibra_iket = eom_ccsd_22_trans_aiaiakdk_aikd(t2, nocc, nactive, a, i, k, d)
ck = (a - nvirt0) * nocc + (k - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
bj = (a - nvirt0) * nocc + (i - nocc0) + 1
...
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
call sigup_nondiag(jac_ibra_iket, ibra, iket)
end do i_aiaiakdk_aikd
end do a_aiaiakdk_aikd
end do k_aiaiakdk_aikd
end do d_aiaiakdk_aikd
!
! Elementary loop  26
! --------------------
! Free virtual indices: a, d
...
if ((n1jk .ge. n0jk).and. (n1il .ge. nn0i))jac_ibra_iket = eom_ccsd_22_trans_aiajajdi_ad(t2, &
 nocc, nactive, a, d)
...
nn0i = max(j + 1, n0il)
if ((n1il .ge. nn0i))jac_ibra_iket = eom_ccsd_22_trans_aiajajdi_ajd(t2, nocc, nactive, &
 a, j, d)
i0 = max(j + 1, n0il)
...
nn1j = min(i - 1, n1jk)
if ((nn1j .ge. n0jk))jac_ibra_iket = eom_ccsd_22_trans_aiajajdi_aid(t2, nocc, nactive, &
 a, i, d)
j1 = min(i - 1, n1jk)
...
jac_ibra_iket = eom_ccsd_22_trans_aiajajdi_aijd(t2, nocc, nactive, a, i, j, d)
bj = (a - nvirt0) * nocc + (j - nocc0) + 1
ck = (a - nvirt0) * nocc + (j - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
dl = (d - nvirt0) * nocc + (i - nocc0) + 1
...
jac_ibra_iket = eom_ccsd_22_trans_aiajajdj_aijd(t2, nocc, nactive, a, i, j, d)
bj = (a - nvirt0) * nocc + (j - nocc0) + 1
ck = (a - nvirt0) * nocc + (j - nocc0) + 1
ai = (a - nvirt0) * nocc + (i - nocc0) + 1
dl = (d - nvirt0) * nocc + (j - nocc0) + 1
...
end subroutine ccjac_22_dav_part10
end module ccjac_block_22_dav_part10
