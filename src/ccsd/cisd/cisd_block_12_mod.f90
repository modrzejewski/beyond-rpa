...
implicit none
!
! File generated automatically on 2014-11-10 21:36:08 UTC.
!
contains
subroutine cisd_block_12(hci, nocc0, nocc1, nvirt0, nvirt1, n0a, n1a, n0b, n1b, n0c, &
 n1c, n0i, n1i, n0j, n1j, n0k, n1k, bra0, ket0) 
...
hci(ibra, iket) = cisd12_aiajck(i, j, c, k)
end do i_aiajck
end do a_aiajck
end do j_aiajck
end do k_aiajck
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aibjak(i, b, j, k)
end do i_aibjak
end do a_aibjak
end do j_aibjak
end do b_aibjak
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aibjci(a, b, j, c)
end do i_aibjci
end do a_aibjci
end do j_aibjci
end do b_aibjci
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aibick(a, b, c, k)
end do i_aibick
end do a_aibick
end do b_aibick
end do k_aibick
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aiajak(a, i, j, k)
end do i_aiajak
end do a_aiajak
end do j_aiajak
end do k_aiajak
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aibjbi(a, b, j)
end do i_aibjbi
end do a_aibjbi
end do j_aibjbi
end do b_aibjbi
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aibibk(a, b, k)
end do i_aibibk
end do a_aibibk
end do b_aibibk
end do k_aibibk
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aiajci(a, i, j, c)
end do i_aiajci
end do a_aiajci
end do j_aiajci
end do c_aiajci
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aiajcj(i, j, c)
end do i_aiajcj
end do a_aiajcj
end do j_aiajcj
end do c_aiajcj
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aiaick(a, i, c, k)
end do i_aiaick
end do a_aiaick
end do k_aiaick
end do c_aiaick
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aibjai(a, i, b, j)
end do i_aibjai
end do a_aibjai
end do j_aibjai
end do b_aibjai
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aibjaj(i, b, j)
end do i_aibjaj
end do a_aibjaj
end do j_aibjaj
end do b_aibjaj
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aibiak(a, i, b, k)
end do i_aibiak
end do a_aibiak
end do b_aibiak
end do k_aibiak
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aibici(a, i, b, c)
end do i_aibici
end do a_aibici
end do b_aibici
end do c_aibici
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aiajai(a, i, j)
end do i_aiajai
end do a_aiajai
end do j_aiajai
!
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aiajaj(a, i, j)
end do i_aiajaj
end do a_aiajaj
end do j_aiajaj
!
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aiaiak(a, i, k)
end do i_aiaiak
end do a_aiaiak
end do k_aiaiak
!
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aibibi(a, i, b)
end do i_aibibi
end do a_aibibi
end do b_aibibi
!
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aiaici(a, i, c)
end do i_aiaici
end do a_aiaici
end do c_aiaici
!
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aibiai(a, i, b)
end do i_aibiai
end do a_aibiai
end do b_aibiai
!
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci(ibra, iket) = cisd12_aiaiai(a, i)
end do i_aiaiai
end do a_aiaiai
end subroutine cisd_block_12
end module cisd_block_12_mod
