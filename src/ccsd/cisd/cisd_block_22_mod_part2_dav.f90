module cisd_block_22_mod_part2_dav
use cisd22
use math_constants
use arithmetic
use cmpidx
...
!
contains
subroutine cisd_block_22_part2_dav(sigup_diag, sigup_nondiag, nocc0, nocc1, nvirt0, nvirt1, &
...
hci_ibra_iket = cisd22_aibiakdi(i, b, k, d)
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjaidi(i, b, j, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjaidi
end do a_aibjaidi
end do j_aibjaidi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjajdi(a, b, j, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjajdi
end do a_aibjajdi
end do j_aibjajdi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjajdj(i, b, j, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjajdj
end do a_aibjajdj
end do j_aibjajdj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjaidj(a, i, b, j, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjaidj
end do a_aibjaidj
end do j_aibjaidj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibiaidl(i, b, d, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibiaidl
end do a_aibiaidl
end do b_aibiaidl
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjbkbi(a, b, j, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbkbi
end do a_aibjbkbi
end do j_aibjbkbi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjbkbj(a, i, b, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbkbj
end do a_aibjbkbj
end do j_aibjbkbj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjbibl(a, b, j, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbibl
end do a_aibjbibl
end do j_aibjbibl
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjbjbl(a, i, b, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbjbl
end do a_aibjbjbl
end do j_aibjbjbl
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjcjci(a, b, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjcjci
end do a_aibjcjci
end do j_aibjcjci
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjcicj(a, b, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjcicj
end do a_aibjcicj
end do j_aibjcicj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibibkdi(a, i, k, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibibkdi
end do a_aibibkdi
end do b_aibibkdi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjbidi(a, i, j, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbidi
end do a_aibjbidi
end do j_aibjbidi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjbjdi(a, i, b, j, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbjdi
end do a_aibjbjdi
end do j_aibjbjdi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjbjdj(a, i, j, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbjdj
end do a_aibjbjdj
end do j_aibjbjdj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjbidj(a, i, b, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbidj
end do a_aibjbidj
end do j_aibjbidj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibibidl(a, i, d, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibibidl
end do a_aibibidl
end do b_aibibidl
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajckai(a, j, c, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajckai
end do a_aiajckai
end do j_aiajckai
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajckaj(a, i, c, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajckaj
end do a_aiajckaj
end do j_aiajckaj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajcial(a, j, c, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajcial
end do a_aiajcial
end do j_aiajcial
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajcjal(a, i, c, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajcjal
end do a_aiajcjal
end do j_aiajcjal
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibickai(i, b, c, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibickai
end do a_aibickai
end do b_aibickai
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjciai(i, b, j, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjciai
end do a_aibjciai
end do j_aibjciai
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjcjai(a, i, b, j, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjcjai
end do a_aibjcjai
end do j_aibjcjai
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjcjaj(i, b, j, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjcjaj
end do a_aibjcjaj
end do j_aibjcjaj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjciaj(a, b, j, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjciaj
end do a_aibjciaj
end do j_aibjciaj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibicial(i, b, c, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibicial
end do a_aibicial
end do b_aibicial
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajcjdi(a, c, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajcjdi
end do a_aiajcjdi
end do j_aiajcjdi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajcidj(a, c, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajcidj
end do a_aiajcidj
end do j_aiajcidj
...
end subroutine cisd_block_22_part2_dav
end module cisd_block_22_mod_part2_dav
