module cisd_block_22_mod_part1_dav
use cisd22
use math_constants
use arithmetic
use cmpidx
...
!
contains
subroutine cisd_block_22_part1_dav(sigup_diag, sigup_nondiag, nocc0, nocc1, nvirt0, nvirt1, &
...
hci_ibra_iket = cisd22_aibjakbl(i, j, k, l)
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjakdi(b, j, k, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjakdi
end do a_aibjakdi
end do j_aibjakdi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjakdj(i, b, k, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjakdj
end do a_aibjakdj
end do j_aibjakdj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjaidl(b, j, d, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjaidl
end do a_aibjaidl
end do j_aibjaidl
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjbkdi(a, j, k, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbkdi
end do a_aibjbkdi
end do j_aibjbkdi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjbkdj(a, i, k, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbkdj
end do a_aibjbkdj
end do j_aibjbkdj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjbjdl(a, i, d, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbjdl
end do a_aibjbjdl
end do j_aibjbjdl
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjckai(b, j, c, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjckai
end do a_aibjckai
end do j_aibjckai
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjcial(b, j, c, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjcial
end do a_aibjcial
end do j_aibjcial
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjcjal(i, b, c, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjcjal
end do a_aibjcjal
end do j_aibjcjal
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjckbj(a, i, c, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjckbj
end do a_aibjckbj
end do j_aibjckbj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjcibl(a, j, c, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjcibl
end do a_aibjcibl
end do j_aibjcibl
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjcjbl(a, i, c, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjcjbl
end do a_aibjcjbl
end do j_aibjcjbl
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjcjdi(a, b, c, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjcjdi
end do a_aibjcjdi
end do j_aibjcjdi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjcidj(a, b, c, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjcidj
end do a_aibjcidj
end do j_aibjcidj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajakal(i, j, k, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajakal
end do a_aiajakal
end do j_aiajakal
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjakai(a, b, j, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjakai
end do a_aibjakai
end do j_aibjakai
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjakaj(a, i, b, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjakaj
end do a_aibjakaj
end do j_aibjakaj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjaial(a, b, j, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjaial
end do a_aibjaial
end do j_aibjaial
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjajal(a, i, b, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjajal
end do a_aibjajal
end do j_aibjajal
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajakdi(a, j, k, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajakdi
end do a_aiajakdi
end do j_aiajakdi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajakdj(a, i, k, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajakdj
end do a_aiajakdj
end do j_aiajakdj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajaidl(a, j, d, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajaidl
end do a_aiajaidl
end do j_aiajaidl
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajajdl(a, i, d, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajajdl
end do a_aiajajdl
end do j_aiajajdl
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjakbi(i, b, j, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjakbi
end do a_aibjakbi
end do j_aibjakbi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjakbj(a, i, b, j, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjakbj
end do a_aibjakbj
end do j_aibjakbj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjakbk(i, j, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjakbk
end do a_aibjakbk
end do j_aibjakbk
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibiakbl(i, k, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibiakbl
end do a_aibiakbl
end do b_aibiakbl
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjaibl(a, i, b, j, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjaibl
end do a_aibjaibl
end do j_aibjaibl
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjajbl(a, i, j, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjajbl
end do a_aibjajbl
end do j_aibjajbl
...
end subroutine cisd_block_22_part1_dav
end module cisd_block_22_mod_part1_dav
