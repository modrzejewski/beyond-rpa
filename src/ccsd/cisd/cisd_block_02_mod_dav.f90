...
implicit none
!
! File generated automatically on 2014-11-13 22:33:04 UTC.
!
contains
subroutine cisd_block_02_dav(sigup_diag, sigup_nondiag, nocc0, nocc1, nvirt0, nvirt1, &
...
hci_ibra_iket = cisd02_aiaj(a, i, j)
...
iket = ketoffset + &
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
hci_ibra_iket = cisd02_aibi(a, i, b)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibi
end do a_aibi
end do b_aibi
...
iket = ketoffset + &
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
hci_ibra_iket = cisd02_aibj(a, i, b, j)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibj
end do a_aibj
end do j_aibj
end do b_aibj
end subroutine cisd_block_02_dav
end module cisd_block_02_mod_dav
