module cisd_block_22_mod_part4_dav
use cisd22
use math_constants
use arithmetic
use cmpidx
...
!
contains
subroutine cisd_block_22_part4_dav(sigup_diag, sigup_nondiag, nocc0, nocc1, nvirt0, nvirt1, &
...
hci_ibra_iket = cisd22_aibiakbk(i, k)
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibiaibl(a, i, b, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibiaibl
end do a_aibiaibl
end do b_aibiaibl
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibiaidi(a, i, b, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibiaidi
end do a_aibiaidi
end do b_aibiaidi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibibkbi(a, i, b, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibibkbi
end do a_aibibkbi
end do b_aibibkbi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjbibi(a, i, b, j)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbibi
end do a_aibjbibi
end do j_aibjbibi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjbjbi(a, i, b, j)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbjbi
end do a_aibjbjbi
end do j_aibjbjbi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjbjbj(a, i, b, j)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbjbj
end do a_aibjbjbj
end do j_aibjbjbj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibjbibj(a, i, b, j)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbibj
end do a_aibjbibj
end do j_aibjbibj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibibibl(a, i, b, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibibibl
end do a_aibibibl
end do b_aibibibl
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajcicj(a, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajcicj
end do a_aiajcicj
end do j_aiajcicj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibicici(a, b, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibicici
end do a_aibicici
end do b_aibicici
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibibidi(a, i, b, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibibidi
end do a_aibibidi
end do b_aibibidi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiaickai(a, i, c, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiaickai
end do a_aiaickai
end do k_aiaickai
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajciai(a, i, j, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajciai
end do a_aiajciai
end do j_aiajciai
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajcjai(a, i, j, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajcjai
end do a_aiajcjai
end do j_aiajcjai
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajcjaj(a, i, j, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajcjaj
end do a_aiajcjaj
end do j_aiajcjaj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajciaj(a, i, j, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajciaj
end do a_aiajciaj
end do j_aiajciaj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiaicial(a, i, c, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiaicial
end do a_aiaicial
end do c_aiaicial
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibiciai(a, i, b, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibiciai
end do a_aibiciai
end do b_aibiciai
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiaicidi(a, c, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiaicidi
end do a_aiaicidi
end do c_aiaicidi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibicibi(a, i, b, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibicibi
end do a_aibicibi
end do b_aibicibi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiaiakai(a, i, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiaiakai
end do a_aiaiakai
end do k_aiaiakai
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajaiai(a, i, j)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajaiai
end do a_aiajaiai
end do j_aiajaiai
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajajaj(a, i, j)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajajaj
end do a_aiajajaj
end do j_aiajajaj
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiajaiaj(eorb, nocc, a, i, j)
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiaiakak(i, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiaiakak
end do a_aiaiakak
end do k_aiaiakak
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiaiaial(a, i, l)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiaiaial
end do a_aiaiaial
end do l_aiaiaial
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibiaiai(a, i, b)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibiaiai
end do a_aibiaiai
end do b_aibiaiai
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aiaiaidi(a, i, d)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiaiaidi
end do a_aiaiaidi
end do d_aiaiaidi
...
iket = ketoffset + &
((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
hci_ibra_iket = cisd22_aibiaibi(eorb, nocc, a, i, b)
hci_ibra_iket = hci_ibra_iket + e_nuclear
call sigup_diag(hci_ibra_iket, ibra)
end do i_aibiaibi
end do a_aibiaibi
end do b_aibiaibi
end subroutine cisd_block_22_part4_dav
end module cisd_block_22_mod_part4_dav
