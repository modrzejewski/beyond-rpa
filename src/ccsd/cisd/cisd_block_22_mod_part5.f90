module cisd_block_22_mod_part5
      use cisd22
      use math_constants
      use arithmetic
      use cmpidx
      ...
      !
contains
      subroutine cisd_block_22_part5(hci, nocc0, nocc1, nvirt0, nvirt1, n0a, n1a, n0b, &
            ...
            b_aibibibi: do b = n0bcd, n1bcd
                  ...
                  a_aibibibi: do a = a0, n1a
                        ...
                        i_aibibibi: do i = n0ijkl, n1ijkl
                              ...
                              hci(ibra, iket) = cisd22_aibibibi(a, i, b)
                        end do i_aibibibi
                  end do a_aibibibi
            end do b_aibibibi
            !
            ...
            c_aiaicici: do c = n0cd, n1cd
                  a_aiaicici: do a = n0ab, n1ab
                        ...
                        i_aiaicici: do i = n0ijkl, n1ijkl
                              ...
                              iket = ketoffset + &
                                    ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                              hci(ibra, iket) = cisd22_aiaicici(a, c)
                        end do i_aiaicici
                  end do a_aiaicici
            end do c_aiaicici
            !
            ...
            c_aiaiciai: do c = n0c, n1c
                  ...
                  a_aiaiciai: do a = n0abd, a1
                        ...
                        i_aiaiciai: do i = n0ijkl, n1ijkl
                              ...
                              iket = ketoffset + &
                                    ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                              hci(ibra, iket) = cisd22_aiaiciai(a, i, c)
                        end do i_aiaiciai
                  end do a_aiaiciai
            end do c_aiaiciai
            !
            ...
            a_aiaiaiai: do a = n0abcd, n1abcd
                  i_aiaiaiai: do i = n0ijkl, n1ijkl
                        ...
                        iket = ketoffset + &
                              ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                        hci(ibra, iket) = cisd22_aiaiaiai(eorb, nocc, a, i)
                  end do i_aiaiaiai
            end do a_aiaiaiai
      end subroutine cisd_block_22_part5
end module cisd_block_22_mod_part5
