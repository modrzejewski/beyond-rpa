...
implicit none
!
! File generated automatically on 2014-11-13 22:33:07 UTC.
!
contains
subroutine cisd_block_12_dav(sigup_diag, sigup_nondiag, nocc0, nocc1, nvirt0, nvirt1, &
...
hci_ibra_iket = cisd12_aiajck(i, j, c, k)
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aibjak(i, b, j, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjak
end do a_aibjak
end do j_aibjak
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aibjci(a, b, j, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjci
end do a_aibjci
end do j_aibjci
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aibick(a, b, c, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibick
end do a_aibick
end do b_aibick
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aiajak(a, i, j, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajak
end do a_aiajak
end do j_aiajak
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aibjbi(a, b, j)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjbi
end do a_aibjbi
end do j_aibjbi
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aibibk(a, b, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibibk
end do a_aibibk
end do b_aibibk
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aiajci(a, i, j, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajci
end do a_aiajci
end do j_aiajci
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aiajcj(i, j, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajcj
end do a_aiajcj
end do j_aiajcj
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aiaick(a, i, c, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiaick
end do a_aiaick
end do k_aiaick
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aibjai(a, i, b, j)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjai
end do a_aibjai
end do j_aibjai
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aibjaj(i, b, j)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibjaj
end do a_aibjaj
end do j_aibjaj
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aibiak(a, i, b, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibiak
end do a_aibiak
end do b_aibiak
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aibici(a, i, b, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibici
end do a_aibici
end do b_aibici
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aiajai(a, i, j)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajai
end do a_aiajai
end do j_aiajai
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aiajaj(a, i, j)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiajaj
end do a_aiajaj
end do j_aiajaj
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aiaiak(a, i, k)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiaiak
end do a_aiaiak
end do k_aiaiak
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aibibi(a, i, b)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibibi
end do a_aibibi
end do b_aibibi
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aiaici(a, i, c)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiaici
end do a_aiaici
end do c_aiaici
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aibiai(a, i, b)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aibiai
end do a_aibiai
end do b_aibiai
...
iket = ketoffset + &
((2 * npair - ck + 2) * (ck - 1)) / 2 + bj - ck + 1
hci_ibra_iket = cisd12_aiaiai(a, i)
call sigup_nondiag(hci_ibra_iket, ibra, iket)
end do i_aiaiai
end do a_aiaiai
end subroutine cisd_block_12_dav
end module cisd_block_12_mod_dav
