module cisd_block_22_mod_part3
      use cisd22
      use math_constants
      use arithmetic
      use cmpidx
      ...
      !
contains
      subroutine cisd_block_22_part3(hci, nocc0, nocc1, nvirt0, nvirt1, n0a, n1a, n0b, &
                        ...
                        b_aibickbi: do b = n0bd, b1
                              ...
                              a_aibickbi: do a = a0, n1a
                                    ...
                                    i_aibickbi: do i = n0ijl, n1ijl
                                          ...
                                          hci(ibra, iket) = cisd22_aibickbi(a, i, c, k)
                                    end do i_aibickbi
                              end do a_aibickbi
                        end do b_aibickbi
                  end do k_aibickbi
                        ...
                        j_aibjcibi: do j = n0j, n1j
                              ...
                              a_aibjcibi: do a = a0, n1a
                                    ...
                                    i_aibjcibi: do i = n0ikl, n1ikl
                                          ...
                                          iket = ketoffset + &
                                                ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                          hci(ibra, iket) = cisd22_aibjcibi(a, i, j, c)
                                    end do i_aibjcibi
                              end do a_aibjcibi
                        end do j_aibjcibi
                  end do b_aibjcibi
                        ...
                        j_aibjcjbi: do j = n0jk, n1jk
                              ...
                              a_aibjcjbi: do a = a0, n1a
                                    ...
                                    i_aibjcjbi: do i = n0il, n1il
                                          ...
                                          iket = ketoffset + &
                                                ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                          hci(ibra, iket) = cisd22_aibjcjbi(a, i, b, c)
                                    end do i_aibjcjbi
                              end do a_aibjcjbi
                        end do j_aibjcjbi
                  end do b_aibjcjbi
                        ...
                        j_aibjcjbj: do j = n0jkl, n1jkl
                              ...
                              a_aibjcjbj: do a = a0, n1a
                                    ...
                                    i_aibjcjbj: do i = n0i, n1i
                                          ...
                                          iket = ketoffset + &
                                                ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                          hci(ibra, iket) = cisd22_aibjcjbj(a, i, j, c)
                                    end do i_aibjcjbj
                              end do a_aibjcjbj
                        end do j_aibjcjbj
                  end do b_aibjcjbj
                        ...
                        j_aibjcibj: do j = n0jl, n1jl
                              ...
                              a_aibjcibj: do a = a0, n1a
                                    ...
                                    i_aibjcibj: do i = n0ik, n1ik
                                          ...
                                          iket = ketoffset + &
                                                ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                          hci(ibra, iket) = cisd22_aibjcibj(a, i, b, j, c)
                                    end do i_aibjcibj
                              end do a_aibjcibj
                        end do j_aibjcibj
                  end do b_aibjcibj
                        ...
                        b_aibicibl: do b = n0bd, b1
                              ...
                              a_aibicibl: do a = a0, n1a
                                    ...
                                    i_aibicibl: do i = n0ijk, n1ijk
                                          ...
                                          iket = ketoffset + &
                                                ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                          hci(ibra, iket) = cisd22_aibicibl(a, i, c, l)
                                    end do i_aibicibl
                              end do a_aibicibl
                        end do b_aibicibl
                  end do c_aibicibl
                        ...
                        b_aibicidi: do b = n0b, n1b
                              ...
                              a_aibicidi: do a = a0, n1a
                                    ...
                                    i_aibicidi: do i = n0ijkl, n1ijkl
                                          ...
                                          iket = ketoffset + &
                                                ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                          hci(ibra, iket) = cisd22_aibicidi(a, b, c, d)
                                    end do i_aibicidi
                              end do a_aibicidi
                        end do b_aibicidi
                  end do c_aibicidi
                  ...
                  j_aiajakai: do j = n0j, n1j
                        ...
                        a_aiajakai: do a = n0abcd, n1abcd
                              ...
                              i_aiajakai: do i = i0, i1
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aiajakai(a, i, j, k)
                              end do i_aiajakai
                        end do a_aiajakai
                  end do j_aiajakai
            end do k_aiajakai
                  ...
                  j_aiajakaj: do j = n0jl, j1
                        ...
                        a_aiajakaj: do a = n0abcd, n1abcd
                              ...
                              i_aiajakaj: do i = i0, n1i
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aiajakaj(a, i, j, k)
                              end do i_aiajakaj
                        end do a_aiajakaj
                  end do j_aiajakaj
            end do k_aiajakaj
                  ...
                  j_aiajakak: do j = n0j, n1j
                        ...
                        a_aiajakak: do a = n0abcd, n1abcd
                              ...
                              i_aiajakak: do i = i0, n1i
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aiajakak(i, j, k)
                              end do i_aiajakak
                        end do a_aiajakak
                  end do j_aiajakak
            end do k_aiajakak
                  ...
                  k_aiaiakal: do k = k0, n1k
                        ...
                        a_aiaiakal: do a = n0abcd, n1abcd
                              ...
                              i_aiaiakal: do i = n0ij, n1ij
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aiaiakal(i, k, l)
                              end do i_aiaiakal
                        end do a_aiaiakal
                  end do k_aiaiakal
            end do l_aiaiakal
                  ...
                  j_aiajaial: do j = n0j, n1j
                        ...
                        a_aiajaial: do a = n0abcd, n1abcd
                              ...
                              i_aiajaial: do i = i0, n1ik
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aiajaial(a, i, j, l)
                              end do i_aiajaial
                        end do a_aiajaial
                  end do j_aiajaial
            end do l_aiajaial
                  ...
                  j_aiajajal: do j = j0, n1jk
                        ...
                        a_aiajajal: do a = n0abcd, n1abcd
                              ...
                              i_aiajajal: do i = i0, n1i
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aiajajal(a, i, j, l)
                              end do i_aiajajal
                        end do a_aiajajal
                  end do j_aiajajal
            end do l_aiajajal
                  ...
                  b_aibiakai: do b = n0b, n1b
                        ...
                        a_aibiakai: do a = a0, n1acd
                              ...
                              i_aibiakai: do i = n0ijl, i1
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aibiakai(a, i, b, k)
                              end do i_aibiakai
                        end do a_aibiakai
                  end do b_aibiakai
            end do k_aibiakai
                  ...
                  j_aibjaiai: do j = n0j, n1j
                        ...
                        a_aibjaiai: do a = a0, n1acd
                              ...
                              i_aibjaiai: do i = n0ikl, n1ikl
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aibjaiai(a, i, b, j)
                              end do i_aibjaiai
                        end do a_aibjaiai
                  end do j_aibjaiai
            end do b_aibjaiai
                  ...
                  j_aibjajai: do j = n0jk, n1jk
                        ...
                        a_aibjajai: do a = a0, n1acd
                              ...
                              i_aibjajai: do i = n0il, i1
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aibjajai(a, i, b, j)
                              end do i_aibjajai
                        end do a_aibjajai
                  end do j_aibjajai
            end do b_aibjajai
                  ...
                  j_aibjajaj: do j = n0jkl, n1jkl
                        ...
                        a_aibjajaj: do a = a0, n1acd
                              ...
                              i_aibjajaj: do i = n0i, n1i
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aibjajaj(a, i, b, j)
                              end do i_aibjajaj
                        end do a_aibjajaj
                  end do j_aibjajaj
            end do b_aibjajaj
                  ...
                  j_aibjaiaj: do j = n0jl, n1jl
                        ...
                        a_aibjaiaj: do a = a0, n1acd
                              ...
                              i_aibjaiaj: do i = i0, n1ik
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aibjaiaj(a, i, b, j)
                              end do i_aibjaiaj
                        end do a_aibjaiaj
                  end do j_aibjaiaj
            end do b_aibjaiaj
                  ...
                  b_aibiaial: do b = n0b, n1b
                        ...
                        a_aibiaial: do a = a0, n1acd
                              ...
                              i_aibiaial: do i = i0, n1ijk
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aibiaial(a, i, b, l)
                              end do i_aibiaial
                        end do a_aibiaial
                  end do b_aibiaial
            end do l_aibiaial
                  ...
                  k_aiaiakdi: do k = n0k, n1k
                        ...
                        a_aiaiakdi: do a = a0, n1abc
                              ...
                              i_aiaiakdi: do i = n0ijl, n1ijl
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aiaiakdi(a, i, k, d)
                              end do i_aiaiakdi
                        end do a_aiaiakdi
                  end do k_aiaiakdi
            end do d_aiaiakdi
                  ...
                  j_aiajaidi: do j = n0j, n1j
                        ...
                        a_aiajaidi: do a = a0, n1abc
                              ...
                              i_aiajaidi: do i = i0, n1ikl
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aiajaidi(a, i, j, d)
                              end do i_aiajaidi
                        end do a_aiajaidi
                  end do j_aiajaidi
            end do d_aiajaidi
                  ...
                  j_aiajajdi: do j = n0jk, n1jk
                        ...
                        a_aiajajdi: do a = a0, n1abc
                              ...
                              i_aiajajdi: do i = i0, n1il
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aiajajdi(a, i, j, d)
                              end do i_aiajajdi
                        end do a_aiajajdi
                  end do j_aiajajdi
            end do d_aiajajdi
                  ...
                  j_aiajajdj: do j = n0jkl, n1jkl
                        ...
                        a_aiajajdj: do a = a0, n1abc
                              ...
                              i_aiajajdj: do i = i0, n1i
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aiajajdj(a, i, j, d)
                              end do i_aiajajdj
                        end do a_aiajajdj
                  end do j_aiajajdj
            end do d_aiajajdj
                  ...
                  j_aiajaidj: do j = n0jl, n1jl
                        ...
                        a_aiajaidj: do a = a0, n1abc
                              ...
                              i_aiajaidj: do i = i0, n1ik
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aiajaidj(a, i, j, d)
                              end do i_aiajaidj
                        end do a_aiajaidj
                  end do j_aiajaidj
            end do d_aiajaidj
                  ...
                  l_aiaiaidl: do l = n0l, n1l
                        ...
                        a_aiaiaidl: do a = a0, n1abc
                              ...
                              i_aiaiaidl: do i = n0ijk, n1ijk
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aiaiaidl(a, i, d, l)
                              end do i_aiaiaidl
                        end do a_aiaiaidl
                  end do l_aiaiaidl
            end do d_aiaiaidl
                  ...
                  b_aibiakbi: do b = n0bd, n1bd
                        ...
                        a_aibiakbi: do a = a0, n1ac
                              ...
                              i_aibiakbi: do i = n0ijl, n1ijl
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aibiakbi(a, i, b, k)
                              end do i_aibiakbi
                        end do a_aibiakbi
                  end do b_aibiakbi
            end do k_aibiakbi
                  ...
                  j_aibjaibi: do j = n0j, n1j
                        ...
                        a_aibjaibi: do a = a0, n1ac
                              ...
                              i_aibjaibi: do i = n0ikl, n1ikl
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aibjaibi(a, i, b, j)
                              end do i_aibjaibi
                        end do a_aibjaibi
                  end do j_aibjaibi
            end do b_aibjaibi
                  ...
                  j_aibjajbi: do j = n0jk, n1jk
                        ...
                        a_aibjajbi: do a = a0, n1ac
                              ...
                              i_aibjajbi: do i = n0il, n1il
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aibjajbi(a, i, b, j)
                              end do i_aibjajbi
                        end do a_aibjajbi
                  end do j_aibjajbi
            end do b_aibjajbi
                  ...
                  j_aibjajbj: do j = n0jkl, n1jkl
                        ...
                        a_aibjajbj: do a = a0, n1ac
                              ...
                              i_aibjajbj: do i = n0i, n1i
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aibjajbj(a, i, b, j)
                              end do i_aibjajbj
                        end do a_aibjajbj
                  end do j_aibjajbj
            end do b_aibjajbj
                  ...
                  j_aibjaibj: do j = n0jl, n1jl
                        ...
                        a_aibjaibj: do a = a0, n1ac
                              ...
                              i_aibjaibj: do i = n0ik, n1ik
                                    ...
                                    iket = ketoffset + &
                                          ((2 * npair - dl + 2) * (dl - 1)) / 2 + ck - dl + 1
                                    hci(ibra, iket) = cisd22_aibjaibj(eorb, nocc, a, i, b, j)
                              end do i_aibjaibj
                        end do a_aibjaibj
                  end do j_aibjaibj
            end do b_aibjaibj
      end subroutine cisd_block_22_part3
end module cisd_block_22_mod_part3
