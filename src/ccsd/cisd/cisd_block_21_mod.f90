...
implicit none
!
! File generated automatically on 2014-11-10 21:36:14 UTC.
!
contains
subroutine cisd_block_21(hci, nocc0, nocc1, nvirt0, nvirt1, n0a, n1a, n0b, n1b, n0c, &
...
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aibjak(i, b, j, k)
end do i_aibjak
end do a_aibjak
end do j_aibjak
end do b_aibjak
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aibjbk(a, i, j, k)
end do i_aibjbk
end do a_aibjbk
end do j_aibjbk
end do b_aibjbk
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aibjcj(a, i, b, c)
end do i_aibjcj
end do a_aibjcj
end do j_aibjcj
end do b_aibjcj
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aibjci(a, b, j, c)
end do i_aibjci
end do a_aibjci
end do j_aibjci
end do b_aibjci
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aiajak(a, i, j, k)
end do i_aiajak
end do a_aiajak
end do j_aiajak
end do k_aiajak
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aibiak(i, b, k)
end do i_aibiak
end do a_aibiak
end do b_aibiak
end do k_aibiak
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aibjaj(a, i, b, j)
end do i_aibjaj
end do a_aibjaj
end do j_aibjaj
end do b_aibjaj
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aibjai(a, i, b, j)
end do i_aibjai
end do a_aibjai
end do j_aibjai
end do b_aibjai
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aiajcj(a, i, c)
end do i_aiajcj
end do a_aiajcj
end do j_aiajcj
end do c_aiajcj
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aiajci(a, j, c)
end do i_aiajci
end do a_aiajci
end do j_aiajci
end do c_aiajci
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aibibk(a, i, k)
end do i_aibibk
end do a_aibibk
end do b_aibibk
end do k_aibibk
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aibjbj(a, i, b, j)
end do i_aibjbj
end do a_aibjbj
end do j_aibjbj
end do b_aibjbj
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aibjbi(a, i, b, j)
end do i_aibjbi
end do a_aibjbi
end do j_aibjbi
end do b_aibjbi
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aibici(a, i, b, c)
end do i_aibici
end do a_aibici
end do b_aibici
end do c_aibici
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aiaiak(a, i, k)
end do i_aiaiak
end do a_aiaiak
end do k_aiaiak
!
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aiajaj(a, i, j)
end do i_aiajaj
end do a_aiajaj
end do j_aiajaj
!
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aiajai(a, i, j)
end do i_aiajai
end do a_aiajai
end do j_aiajai
!
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aibiai(a, i, b)
end do i_aibiai
end do a_aibiai
end do b_aibiai
!
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aiaici(a, i, c)
end do i_aiaici
end do a_aiaici
end do c_aiaici
!
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aibibi(a, i, b)
end do i_aibibi
end do a_aibibi
end do b_aibibi
!
...
((2 * npair - bj + 2) * (bj - 1)) / 2 + ai - bj + 1
iket = ketoffset + ck
hci(ibra, iket) = cisd21_aiaiai(a, i)
end do i_aiaiai
end do a_aiaiai
end subroutine cisd_block_21
end module cisd_block_21_mod
