...
* **The high-level CCSD(T) approximation:** We recommend the LNO-CCSD(T) approximation [[Nagy2024](docs/04_literature.md)] implemented in the [MRCC](https://www.mrcc.hu) program.
